...
local aykafwra = io.open("aykafwra", 'w')
aykafwra:write([[
cd $(cd $(dirname $0); pwd)
while(true) do
sudo lua5.3 aykafwra.lua
done
]])
aykafwra:close()
...
screen -S ]]..Redis:get(SshId.."Info:Redis:User")..[[ ./aykafwra
done
]])
Run:close()
...
os.execute('chmod +x aykafwra;chmod +x Run;./Run')
end
...
aykafwra = Token:match("(%d+)")
os.execute('sudo rm -fr .CallBack-Bot/'..aykafwra)
LuaTele = luatele.set_config{api_id=2692371,api_hash='fe85fff033dfe0f328aeb02b4f784930',session_name=aykafwra,token=Token}
function var(value)  
...
Status = 0
DevelopersQ = Redis:sismember(aykafwra.."DevelopersQ:Groups",UserId) 
HELPBEVQ = Redis:sismember(aykafwra.."HELPBEVQ:Groups",UserId) 
Developers = Redis:sismember(aykafwra.."Developers:Groups",UserId) 
TheBasics = Redis:sismember(aykafwra.."TheBasics:Group"..ChatId,UserId) 
TheBasicsQ = Redis:sismember(aykafwra.."TheBasicsQ:Group"..ChatId,UserId) 
Originators = Redis:sismember(aykafwra.."Originators:Group"..ChatId,UserId)
Managers = Redis:sismember(aykafwra.."Managers:Group"..ChatId,UserId)
Addictive = Redis:sismember(aykafwra.."Addictive:Group"..ChatId,UserId)
...
Status = Redis:get(aykafwra.."Developer:Bot:Reply"..ChatId) or 'المطور'
elseif TheBasicsQ then
Status = Redis:get(aykafwra.."PresidentQ:Group:Reply"..ChatId) or 'المالك'
elseif TheBasics then
Status = Redis:get(aykafwra.."President:Group:Reply"..ChatId) or 'المنشئ الاساسي'
elseif Originators then
Status = Redis:get(aykafwra.."Constructor:Group:Reply"..ChatId) or 'المنشئ'
elseif Managers then
Status = Redis:get(aykafwra.."Manager:Group:Reply"..ChatId) or 'المدير'
elseif Addictive then
Status = Redis:get(aykafwra.."Admin:Group:Reply"..ChatId) or 'الادمن'
elseif Distinguished then
Status = Redis:get(aykafwra.."Vip:Group:Reply"..ChatId) or 'المميز'
else
Status = Redis:get(aykafwra.."Mempar:Group:Reply"..ChatId) or 'العضو'
end  
return Status
end 
...
if Redis:get(aykafwra.."lockpin"..ChatId) then    
lock_pin = "✅"
else 
lock_pin = "❎"    
end
if Redis:get(aykafwra.."Lock:tagservr"..ChatId) then    
lock_tagservr = "✅"
else 
lock_tagservr = "❎"
end
if Redis:get(aykafwra.."Lock:text"..ChatId) then    
lock_text = "✅"
else 
lock_text = "❎ "    
end
if Redis:get(aykafwra.."Lock:AddMempar"..ChatId) == "kick" then
lock_add = "✅"
else 
lock_add = "❎ "    
end    
if Redis:get(aykafwra.."Lock:Join"..ChatId) == "kick" then
lock_join = "✅"
else 
lock_join = "❎ "    
end    
if Redis:get(aykafwra.."Lock:edit"..ChatId) then    
lock_edit = "✅"
else 
lock_edit = "❎ "    
end
if Redis:get(aykafwra.."Chek:Welcome"..ChatId) then
welcome = "✅"
else 
welcome = "❎ "    
end
if Redis:hget(aykafwra.."Spam:Group:User"..ChatId, "Spam:User") == "kick" then     
flood = "بالطرد "     
elseif Redis:hget(aykafwra.."Spam:Group:User"..ChatId,"Spam:User") == "keed" then     
flood = "بالتقيد "     
elseif Redis:hget(aykafwra.."Spam:Group:User"..ChatId,"Spam:User") == "mute" then     
flood = "بالكتم "           
elseif Redis:hget(aykafwra.."Spam:Group:User"..ChatId,"Spam:User") == "del" then     
flood = "✅"
else     
flood = "❎ "     
end
if Redis:get(aykafwra.."Lock:Photo"..ChatId) == "del" then
lock_photo = "✅" 
elseif Redis:get(aykafwra.."Lock:Photo"..ChatId) == "ked" then 
lock_photo = "بالتقيد "   
elseif Redis:get(aykafwra.."Lock:Photo"..ChatId) == "ktm" then 
lock_photo = "بالكتم "    
elseif Redis:get(aykafwra.."Lock:Photo"..ChatId) == "kick" then 
lock_photo = "بالطرد "   
else
lock_photo = "❎ "   
end    
if Redis:get(aykafwra.."Lock:Contact"..ChatId) == "del" then
lock_phon = "✅" 
elseif Redis:get(aykafwra.."Lock:Contact"..ChatId) == "ked" then 
lock_phon = "بالتقيد "    
elseif Redis:get(aykafwra.."Lock:Contact"..ChatId) == "ktm" then 
lock_phon = "بالكتم "    
elseif Redis:get(aykafwra.."Lock:Contact"..ChatId) == "kick" then 
lock_phon = "بالطرد "    
else
lock_phon = "❎ "    
end    
if Redis:get(aykafwra.."Lock:Link"..ChatId) == "del" then
lock_links = "✅"
elseif Redis:get(aykafwra.."Lock:Link"..ChatId) == "ked" then
lock_links = "بالتقيد "    
elseif Redis:get(aykafwra.."Lock:Link"..ChatId) == "ktm" then
lock_links = "بالكتم "    
elseif Redis:get(aykafwra.."Lock:Link"..ChatId) == "kick" then
lock_links = "بالطرد "    
else
lock_links = "❎ "    
end
if Redis:get(aykafwra.."Lock:Cmd"..ChatId) == "del" then
lock_cmds = "✅"
elseif Redis:get(aykafwra.."Lock:Cmd"..ChatId) == "ked" then
lock_cmds = "بالتقيد "    
elseif Redis:get(aykafwra.."Lock:Cmd"..ChatId) == "ktm" then
lock_cmds = "بالكتم "   
elseif Redis:get(aykafwra.."Lock:Cmd"..ChatId) == "kick" then
lock_cmds = "بالطرد "    
else
lock_cmds = "❎ "    
end
if Redis:get(aykafwra.."Lock:User:Name"..ChatId) == "del" then
lock_user = "✅"
elseif Redis:get(aykafwra.."Lock:User:Name"..ChatId) == "ked" then
lock_user = "بالتقيد "    
elseif Redis:get(aykafwra.."Lock:User:Name"..ChatId) == "ktm" then
lock_user = "بالكتم "    
elseif Redis:get(aykafwra.."Lock:User:Name"..ChatId) == "kick" then
lock_user = "بالطرد "    
else
lock_user = "❎ "    
end
if Redis:get(aykafwra.."Lock:hashtak"..ChatId) == "del" then
lock_hash = "✅"
elseif Redis:get(aykafwra.."Lock:hashtak"..ChatId) == "ked" then 
lock_hash = "بالتقيد "    
elseif Redis:get(aykafwra.."Lock:hashtak"..ChatId) == "ktm" then 
lock_hash = "بالكتم "    
elseif Redis:get(aykafwra.."Lock:hashtak"..ChatId) == "kick" then 
lock_hash = "بالطرد "    
else
lock_hash = "❎ "    
end
if Redis:get(aykafwra.."Lock:vico"..ChatId) == "del" then
lock_muse = "✅"
elseif Redis:get(aykafwra.."Lock:vico"..ChatId) == "ked" then 
lock_muse = "بالتقيد "    
elseif Redis:get(aykafwra.."Lock:vico"..ChatId) == "ktm" then 
lock_muse = "بالكتم "    
elseif Redis:get(aykafwra.."Lock:vico"..ChatId) == "kick" then 
lock_muse = "بالطرد "    
else
lock_muse = "❎ "    
end 
if Redis:get(aykafwra.."Lock:Video"..ChatId) == "del" then
lock_ved = "✅"
elseif Redis:get(aykafwra.."Lock:Video"..ChatId) == "ked" then 
lock_ved = "بالتقيد "    
elseif Redis:get(aykafwra.."Lock:Video"..ChatId) == "ktm" then 
lock_ved = "بالكتم "    
elseif Redis:get(aykafwra.."Lock:Video"..ChatId) == "kick" then 
lock_ved = "بالطرد "    
else
lock_ved = "❎ "    
end
if Redis:get(aykafwra.."Lock:Animation"..ChatId) == "del" then
lock_gif = "✅"
elseif Redis:get(aykafwra.."Lock:Animation"..ChatId) == "ked" then 
lock_gif = "بالتقيد "    
elseif Redis:get(aykafwra.."Lock:Animation"..ChatId) == "ktm" then 
lock_gif = "بالكتم "    
elseif Redis:get(aykafwra.."Lock:Animation"..ChatId) == "kick" then 
lock_gif = "بالطرد "    
else
lock_gif = "❎ "    
end
if Redis:get(aykafwra.."Lock:Sticker"..ChatId) == "del" then
lock_ste = "✅"
elseif Redis:get(aykafwra.."Lock:Sticker"..ChatId) == "ked" then 
lock_ste = "بالتقيد "    
elseif Redis:get(aykafwra.."Lock:Sticker"..ChatId) == "ktm" then 
lock_ste = "بالكتم "    
elseif Redis:get(aykafwra.."Lock:Sticker"..ChatId) == "kick" then 
lock_ste = "بالطرد "    
else
lock_ste = "❎ "    
end
if Redis:get(aykafwra.."Lock:geam"..ChatId) == "del" then
lock_geam = "✅"
elseif Redis:get(aykafwra.."Lock:geam"..ChatId) == "ked" then 
lock_geam = "بالتقيد "    
elseif Redis:get(aykafwra.."Lock:geam"..ChatId) == "ktm" then 
lock_geam = "بالكتم "    
elseif Redis:get(aykafwra.."Lock:geam"..ChatId) == "kick" then 
lock_geam = "بالطرد "    
else
lock_geam = "❎ "    
end    
...
if Redis:get(aykafwra.."Lock:Keyboard"..ChatId) == "del" then
lock_inlin = "✅"
elseif Redis:get(aykafwra.."Lock:Keyboard"..ChatId) == "ked" then 
lock_inlin = "بالتقيد "
elseif Redis:get(aykafwra.."Lock:Keyboard"..ChatId) == "ktm" then 
lock_inlin = "بالكتم "    
elseif Redis:get(aykafwra.."Lock:Keyboard"..ChatId) == "kick" then 
lock_inlin = "بالطرد "
else
lock_inlin = "❎ "
end
if Redis:get(aykafwra.."Lock:forward"..ChatId) == "del" then
lock_fwd = "✅"
elseif Redis:get(aykafwra.."Lock:forward"..ChatId) == "ked" then 
lock_fwd = "بالتقيد "    
elseif Redis:get(aykafwra.."Lock:forward"..ChatId) == "ktm" then 
lock_fwd = "بالكتم "    
elseif Redis:get(aykafwra.."Lock:forward"..ChatId) == "kick" then 
lock_fwd = "بالطرد "    
else
lock_fwd = "❎ "    
end    
if Redis:get(aykafwra.."Lock:Document"..ChatId) == "del" then
lock_file = "✅"
elseif Redis:get(aykafwra.."Lock:Document"..ChatId) == "ked" then 
lock_file = "بالتقيد "    
elseif Redis:get(aykafwra.."Lock:Document"..ChatId) == "ktm" then 
lock_file = "بالكتم "    
elseif Redis:get(aykafwra.."Lock:Document"..ChatId) == "kick" then 
lock_file = "بالطرد "    
else
lock_file = "❎ "    
end    
if Redis:get(aykafwra.."Lock:Unsupported"..ChatId) == "del" then
lock_self = "✅"
elseif Redis:get(aykafwra.."Lock:Unsupported"..ChatId) == "ked" then 
lock_self = "بالتقيد "    
elseif Redis:get(aykafwra.."Lock:Unsupported"..ChatId) == "ktm" then 
lock_self = "بالكتم "    
elseif Redis:get(aykafwra.."Lock:Unsupported"..ChatId) == "kick" then 
lock_self = "بالطرد "    
else
lock_self = "❎ "    
end
if Redis:get(aykafwra.."Lock:Bot:kick"..ChatId) == "del" then
lock_bots = "✅"
elseif Redis:get(aykafwra.."Lock:Bot:kick"..ChatId) == "ked" then
lock_bots = "بالتقيد "   
elseif Redis:get(aykafwra.."Lock:Bot:kick"..ChatId) == "kick" then
lock_bots = "بالطرد "    
else
lock_bots = "❎ "    
end
if Redis:get(aykafwra.."Lock:Markdaun"..ChatId) == "del" then
lock_mark = "✅"
elseif Redis:get(aykafwra.."Lock:Markdaun"..ChatId) == "ked" then 
lock_mark = "بالتقيد "    
elseif Redis:get(aykafwra.."Lock:Markdaun"..ChatId) == "ktm" then 
lock_mark = "بالكتم "    
elseif Redis:get(aykafwra.."Lock:Markdaun"..ChatId) == "kick" then 
lock_mark = "بالطرد "    
else
lock_mark = "❎ "    
end
if Redis:get(aykafwra.."Lock:Spam"..ChatId) == "del" then    
lock_spam = "✅"
elseif Redis:get(aykafwra.."Lock:Spam"..ChatId) == "ked" then 
lock_spam = "بالتقيد "    
elseif Redis:get(aykafwra.."Lock:Spam"..ChatId) == "ktm" then 
lock_spam = "بالكتم "    
elseif Redis:get(aykafwra.."Lock:Spam"..ChatId) == "kick" then 
lock_spam = "بالطرد "    
else
lock_spam = "❎ "    
end        
...
return{
BanAll = Redis:sismember(aykafwra.."BanAll:Groups",UserId) ,
ktmall = Redis:sismember(aykafwra.."ktmAll:Groups",UserId) ,
BanGroup = Redis:sismember(aykafwra.."BanGroup:Group"..ChatId,UserId) ,
SilentGroup = Redis:sismember(aykafwra.."SilentGroup:Group"..ChatId,UserId)
}
end
...
local GetMemberStatus = LuaTele.getChatMember(msg.chat_id,aykafwra).status
if GetMemberStatus.can_change_info then
...
JoinChannel = true
local Channel = Redis:get(aykafwra..'Channel:Join')
if Channel then
...
Redis:sadd(aykafwra.."allM"..msg.chat_id, msg.id)
if Redis:get(aykafwra.."Status:Del:Media"..msg.chat_id) then    
local Numbardel = Redis:get(aykafwra.."allM:numdel"..msg.chat_id) or 200
local gmedia = Redis:scard(aykafwra.."allM"..msg.chat_id)  
if tonumber(gmedia) >= tonumber(Numbardel) then
local liste = Redis:smembers(aykafwra.."allM"..msg.chat_id)
...
Redis:del(aykafwra.."allM"..msg.chat_id)
end
end
end
if tonumber(msg.sender.user_id) == tonumber(aykafwra) then
...
elseif Redis:sismember(aykafwra.."DevelopersQ:Groups",msg.sender.user_id) == true then
msg.The_Controller = 2
msg.Name_Controller = 'المطور الثانوي'
elseif Redis:sismember(aykafwra.."HELPBEVQ:Groups",msg.sender.user_id) == true then
msg.The_Controller = 22
msg.Name_Controller = 'المساعد'
elseif Redis:sismember(aykafwra.."Developers:Groups",msg.sender.user_id) == true then
msg.The_Controller = 3
msg.Name_Controller = Redis:get(aykafwra.."Developer:Bot:Reply"..msg.chat_id) or 'المطور '
elseif Redis:sismember(aykafwra.."TheBasicsQ:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 44
msg.Name_Controller = Redis:get(aykafwra.."PresidentQ:Group:Reply"..msg.chat_id) or 'المالك'
elseif Redis:sismember(aykafwra.."TheBasics:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 4
msg.Name_Controller = Redis:get(aykafwra.."President:Group:Reply"..msg.chat_id) or 'المنشئ الاساسي'
elseif Redis:sismember(aykafwra.."Originators:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 5
msg.Name_Controller = Redis:get(aykafwra.."Constructor:Group:Reply"..msg.chat_id) or 'المنشئ '
elseif Redis:sismember(aykafwra.."Managers:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 6
msg.Name_Controller = Redis:get(aykafwra.."Manager:Group:Reply"..msg.chat_id) or 'المدير '
elseif Redis:sismember(aykafwra.."Addictive:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 7
msg.Name_Controller = Redis:get(aykafwra.."Admin:Group:Reply"..msg.chat_id) or 'الادمن '
elseif Redis:sismember(aykafwra.."Distinguished:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 8
msg.Name_Controller = Redis:get(aykafwra.."Vip:Group:Reply"..msg.chat_id) or 'المميز '
elseif tonumber(msg.sender.user_id) == tonumber(aykafwra) then
msg.The_Controller = 9
else
msg.The_Controller = 10
msg.Name_Controller = Redis:get(aykafwra.."Mempar:Group:Reply"..msg.chat_id) or 'العضو '
end  
...
if Redis:get(aykafwra.."Lock:text"..msg_chat_id) and not msg.Distinguished then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end 
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(aykafwra.."Status:Welcome"..msg_chat_id) then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Welcome = Redis:get(aykafwra.."Welcome:Group"..msg_chat_id)
if Welcome then 
if UserInfo.username then
...
if not msg.Distinguished and msg.content.luatele ~= "messageChatAddMembers" and Redis:hget(aykafwra.."Spam:Group:User"..msg_chat_id,"Spam:User") then 
if tonumber(msg.sender.user_id) == tonumber(aykafwra) then
return false
end

local floods = Redis:hget(aykafwra.."Spam:Group:User"..msg_chat_id,"Spam:User") or "nil"
local Num_Msg_Max = Redis:hget(aykafwra.."Spam:Group:User"..msg_chat_id,"Num:Spam") or 5
local post_count = tonumber(Redis:get(aykafwra.."Spam:Cont"..msg.sender.user_id..":"..msg_chat_id) or 0)
if post_count >= tonumber(Redis:hget(aykafwra.."Spam:Group:User"..msg_chat_id,"Num:Spam") or 5) then 
local type = Redis:hget(aykafwra.."Spam:Group:User"..msg_chat_id,"Spam:User") 
if type == "kick" then 
...
if type == "mute" then
Redis:sadd(aykafwra.."SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
...
Redis:setex(aykafwra.."Spam:Cont"..msg.sender.user_id..":"..msg_chat_id, tonumber(5), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if Redis:hget(aykafwra.."Spam:Group:User"..msg_chat_id,"Num:Spam") then
Num_Msg_Max = Redis:hget(aykafwra.."Spam:Group:User"..msg_chat_id,"Num:Spam") 
end
end 
if text and Redis:get(aykafwra..'lock:Fshar'..msg.chat_id) and not msg.Distinguished then 
...
if text and Redis:get(aykafwra..'lock:Fars'..msg.chat_id) and not msg.Distinguished then 
...
if text and Redis:get(aykafwra..'lock:Cht'..msg.chat_id) and not msg.Distinguished then 
list = {"كس","كسمك","كسختك","عير","كسخالتك","خرا بالله","عير بالله","كسخواتكم","كحاب","مناويج","مناويج","كحبه","ابن الكحبه","فرخ","فروخ","طيزك","طيزختك","كسمك","يا ابن الخول","المتناك","شرموط","شرموطه","ابن الشرموطه","ابن الخول","ابن العرص","منايك","متناك","احا","ابن المتناكه","زبك","عرص","زبي","خول","لبوه","لباوي","ابن اللبوه","منيوك","كسمكك","متناكه","احو","احي","يا عرص","يا خول","قحبه","القحبه","شراميط","العلق","العلوق","العلقه","كسمك","يا ابن الخول","المتناك","شرموط","شرموطه","ابن الشرموطه","ابن الخول","االمنيوك","كسمككك","الشرموطه","ابن العرث","ابن الحيضانه","زبك","خول","زبي","قاحب"}
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
...
sens = 400  
if Redis:get(aykafwra.."Lock:Spam"..msg.chat_id) == "del" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(aykafwra.."Lock:Spam"..msg.chat_id) == "ked" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'restricted',{1,0,0,0,0,0,0,0,0})
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(aykafwra.."Lock:Spam"..msg.chat_id) == "kick" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(aykafwra.."Lock:Spam"..msg.chat_id) == "ktm" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Redis:sadd(aykafwra.."SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
end
if msg.forward_info and not msg.Developers then -- التوجيه
local Fwd_Group = Redis:get(aykafwra.."Lock:forward"..msg_chat_id)
...
local Keyboard_Group = Redis:get(aykafwra.."Lock:Keyboard"..msg_chat_id)
...
local Markduan_Gtoup = Redis:get(aykafwra.."Lock:Markdaun"..msg_chat_id)
...
local Games_Group = Redis:get(aykafwra.."Lock:geam"..msg_chat_id)
...
local Pin_Msg = Redis:get(aykafwra.."lockpin"..msg_chat_id)
...
Redis:incr(aykafwra.."Num:Add:Memp"..msg_chat_id..":"..msg.sender.user_id) 
local AddMembrs = Redis:get(aykafwra.."Lock:AddMempar"..msg_chat_id) 
local Lock_Bots = Redis:get(aykafwra.."Lock:Bot:kick"..msg_chat_id)
for k,v in pairs(msg.content.member_user_ids) do
local Info_User = LuaTele.getUser(v) 
print(v)
if v == tonumber(aykafwra) then
local N = (Redis:get(aykafwra.."Name:Bot") or "ايكافورا")
photo = LuaTele.getUserProfilePhotos(aykafwra)
...
Redis:set(aykafwra.."Who:Added:Me"..msg_chat_id..":"..v,msg.sender.user_id)
...
Redis:incr(aykafwra.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) 
...
local Contact_Group = Redis:get(aykafwra.."Lock:Contact"..msg_chat_id)
...
local Videonote_Group = Redis:get(aykafwra.."Lock:Unsupported"..msg_chat_id)
...
local Document_Group = Redis:get(aykafwra.."Lock:Document"..msg_chat_id)
...
local Audio_Group = Redis:get(aykafwra.."Lock:Audio"..msg_chat_id)
...
local Video_Grouo = Redis:get(aykafwra.."Lock:Video"..msg_chat_id)
...
local Voice_Group = Redis:get(aykafwra.."Lock:vico"..msg_chat_id)
...
local Sticker_Group = Redis:get(aykafwra.."Lock:Sticker"..msg_chat_id)
...
local Inlen_Group = Redis:get(aykafwra.."Lock:Inlen"..msg_chat_id)
...
local Gif_group = Redis:get(aykafwra.."Lock:Animation"..msg_chat_id)
...
local Photo_Group = Redis:get(aykafwra.."Lock:Photo"..msg_chat_id)
...
if msg.content.photo and Redis:get(aykafwra.."Chat:Photo"..msg_chat_id..":"..msg.sender.user_id) then
...
Redis:del(aykafwra.."Chat:Photo"..msg_chat_id..":"..msg.sender.user_id)
...
local link_Group = Redis:get(aykafwra.."Lock:Link"..msg_chat_id)  
...
local UserName_Group = Redis:get(aykafwra.."Lock:User:Name"..msg_chat_id)
...
if text and text:match("#[%a%d_]+") and not msg.Distinguished then 
local Hashtak_Group = Redis:get(aykafwra.."Lock:hashtak"..msg_chat_id)
...
if text and text:match("/[%a%d_]+") and not msg.Distinguished then 
local comd_Group = Redis:get(aykafwra.."Lock:Cmd"..msg_chat_id)
...
if (Redis:get(aykafwra..'FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'صوره'
Redis:sadd(aykafwra.."List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:set(aykafwra.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.photo.sizes[1].photo.id)  
elseif msg.content.animation then
Filters = 'متحركه'
Redis:sadd(aykafwra.."List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:set(aykafwra.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.animation.animation.id)  
elseif msg.content.sticker then
Filters = 'ملصق'
Redis:sadd(aykafwra.."List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:set(aykafwra.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.sticker.sticker.id)  
elseif text then
Redis:set(aykafwra.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, text)  
Redis:sadd(aykafwra.."List:Filter"..msg_chat_id,'text:'..text)  
Filters = 'نص'
end
Redis:set(aykafwra..'FilterText'..msg_chat_id..':'..msg.sender.user_id,'true1')
return LuaTele.sendText(msg_chat_id,msg_id,"\n𖥔 ارسل تحذير ( "..Filters.." ) عند ارساله","md",true)  
end
end
if text and (Redis:get(aykafwra..'FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true1') then
local Text_Filter = Redis:get(aykafwra.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
if Text_Filter then   
Redis:set(aykafwra.."Filter:Group:"..Text_Filter..msg_chat_id,text)  
end  
Redis:del(aykafwra.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
Redis:del(aykafwra..'FilterText'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n𖥔 تم اضافه رد التحذير","md",true)  
end
if text and (Redis:get(aykafwra..'FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'DelFilter') then   
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'الصوره'
Redis:srem(aykafwra.."List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:del(aykafwra.."Filter:Group:"..msg.content.photo.sizes[1].photo.id..msg_chat_id)  
elseif msg.content.animation then
Filters = 'المتحركه'
Redis:srem(aykafwra.."List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:del(aykafwra.."Filter:Group:"..msg.content.animation.animation.id..msg_chat_id)  
elseif msg.content.sticker then
Filters = 'الملصق'
Redis:srem(aykafwra.."List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:del(aykafwra.."Filter:Group:"..msg.content.sticker.sticker.id..msg_chat_id)  
elseif text then
Redis:srem(aykafwra.."List:Filter"..msg_chat_id,'text:'..text)  
Redis:del(aykafwra.."Filter:Group:"..text..msg_chat_id)  
Filters = 'النص'
end
Redis:del(aykafwra..'FilterText'..msg_chat_id..':'..msg.sender.user_id)
...
local ReplyFilters = Redis:get(aykafwra.."Filter:Group:"..DelFilters..msg_chat_id)
if ReplyFilters then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return LuaTele.sendText(msg_chat_id,msg_id,"*𖥔 لقد تم منع هذه ( "..statusfilter.." ) هنا*\n𖥔 "..ReplyFilters,"md",true)   
end
end
if text and Redis:get(aykafwra.."All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(aykafwra.."All:Get:Reides:Commands:Group"..text)
if NewCmmd then
Redis:del(aykafwra.."All:Get:Reides:Commands:Group"..text)
Redis:del(aykafwra.."All:Command:Reids:Group:New"..msg_chat_id)
Redis:srem(aykafwra.."All:Command:List:Group",text)
...
Redis:del(aykafwra.."All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(aykafwra.."All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(aykafwra.."All:Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(aykafwra.."All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(aykafwra.."All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 ارسل الامر الجديد ليتم وضعه مكان القديم","md",true)  
end
if text and Redis:get(aykafwra.."All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(aykafwra.."All:Command:Reids:Group:New"..msg_chat_id)
Redis:set(aykafwra.."All:Get:Reides:Commands:Group"..text,NewCmd)
Redis:sadd(aykafwra.."All:Command:List:Group",text)
Redis:del(aykafwra.."All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 تم حفظ الامر باسم ← { "..text..' }',"md",true)
end

if text and Redis:get(aykafwra.."Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(aykafwra.."Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
Redis:del(aykafwra.."Get:Reides:Commands:Group"..msg_chat_id..":"..text)
Redis:del(aykafwra.."Command:Reids:Group:New"..msg_chat_id)
Redis:srem(aykafwra.."Command:List:Group"..msg_chat_id,text)
LuaTele.sendText(msg_chat_id,msg_id,"𖥔 تم ازالة هاذا ← { "..text.." }","md",true)
else
LuaTele.sendText(msg_chat_id,msg_id,"𖥔 لا يوجد امر بهاذا الاسم","md",true)
end
Redis:del(aykafwra.."Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(aykafwra.."Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(aykafwra.."Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(aykafwra.."Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(aykafwra.."Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 ارسل الامر الجديد ليتم وضعه مكان القديم","md",true)  
end
if text and Redis:get(aykafwra.."Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(aykafwra.."Command:Reids:Group:New"..msg_chat_id)
Redis:set(aykafwra.."Get:Reides:Commands:Group"..msg_chat_id..":"..text,NewCmd)
Redis:sadd(aykafwra.."Command:List:Group"..msg_chat_id,text)
Redis:del(aykafwra.."Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 تم حفظ الامر باسم ← { "..text..' }',"md",true)
end
if Redis:get(aykafwra.."Set:Link"..msg_chat_id..""..msg.sender.user_id) then
if text == "الغاء" then
Redis:del(aykafwra.."Set:Link"..msg_chat_id..""..msg.sender.user_id) 
...
Redis:set(aykafwra.."Group:Link"..msg_chat_id,LinkGroup)
Redis:del(aykafwra.."Set:Link"..msg_chat_id..""..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"📥︙تم حفظ الرابط بنجاح","md",true)         
end
end 
if Redis:get(aykafwra.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(aykafwra.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 تم الغاء حفظ الترحيب","md",true)   
end 
Redis:del(aykafwra.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
Redis:set(aykafwra.."Welcome:Group"..msg_chat_id,text) 
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 تم حفظ ترحيب الجروب","md",true)     
end
if Redis:get(aykafwra.."Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(aykafwra.."Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 تم الغاء حفظ القوانين","md",true)   
end 
Redis:set(aykafwra.."Group:Rules" .. msg_chat_id,text) 
Redis:del(aykafwra.."Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 تم حفظ قوانين الجروب","md",true)  
end  
if Redis:get(aykafwra.."Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(aykafwra.."Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id)
...
if Redis:get(aykafwra.."Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر 𖥔' then   
Redis:del(aykafwra.."Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n𖥔 تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(aykafwra.."ChekBotAdd") 
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
Redis:set(aykafwra.."PinMsegees:"..v,msg.content.video_note.video.remote.id)
end
...
Redis:set(aykafwra.."PinMsegees:"..v,idPhoto)
end
elseif msg.content.sticker then 
for k,v in pairs(list) do 
LuaTele.sendSticker(v, 0, msg.content.sticker.sticker.remote.id)
Redis:set(aykafwra.."PinMsegees:"..v,msg.content.sticker.sticker.remote.id)
end
elseif msg.content.voice_note then 
for k,v in pairs(list) do 
LuaTele.sendVoiceNote(v, 0, msg.content.voice_note.voice.remote.id, '', 'md')
Redis:set(aykafwra.."PinMsegees:"..v,msg.content.voice_note.voice.remote.id)
end
elseif msg.content.video then 
for k,v in pairs(list) do 
LuaTele.sendVideo(v, 0, msg.content.video.video.remote.id, '', "md")
Redis:set(aykafwra.."PinMsegees:"..v,msg.content.video.video.remote.id)
end
elseif msg.content.animation then 
for k,v in pairs(list) do 
LuaTele.sendAnimation(v,0, msg.content.animation.animation.remote.id, '', 'md')
Redis:set(aykafwra.."PinMsegees:"..v,msg.content.animation.animation.remote.id)
end
elseif msg.content.document then
for k,v in pairs(list) do 
LuaTele.sendDocument(v, 0, msg.content.document.document.remote.id, '', 'md')
Redis:set(aykafwra.."PinMsegees:"..v,msg.content.document.document.remote.id)
end
elseif msg.content.audio then
for k,v in pairs(list) do 
LuaTele.sendAudio(v, 0, msg.content.audio.audio.remote.id, '', "md") 
Redis:set(aykafwra.."PinMsegees:"..v,msg.content.audio.audio.remote.id)
end
elseif text then
for k,v in pairs(list) do 
LuaTele.sendText(v, 0,""..text.."")
Redis:set(aykafwra.."PinMsegees:"..v,text)
end
end
...
------------------------------------------------------------------------------------------------------------
if Redis:get(aykafwra.."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر 𖥔' then   
Redis:del(aykafwra.."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n𖥔 تم الغاء الاذاعه خاص","md",true)  
end 
local list = Redis:smembers(aykafwra..'Num:User:Pv')  
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
end
...
------------------------------------------------------------------------------------------------------------
if Redis:get(aykafwra.."Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر 𖥔' then   
Redis:del(aykafwra.."Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n𖥔 تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(aykafwra.."ChekBotAdd") 
if msg.content.video_note then
...
------------------------------------------------------------------------------------------------------------
if Redis:get(aykafwra.."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر 𖥔' then   
Redis:del(aykafwra.."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(aykafwra.."Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر 𖥔' then   
Redis:del(aykafwra.."Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(aykafwra.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(aykafwra.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
local test = Redis:get(aykafwra.."Text:Manager"..msg.sender.user_id..":"..msg_chat_id)
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(aykafwra.."Add:Rd:Manager:Text"..test..msg_chat_id, text)  
elseif msg.content.sticker then   
Redis:set(aykafwra.."Add:Rd:Manager:Stekrs"..test..msg_chat_id, msg.content.sticker.sticker.remote.id)  
elseif msg.content.voice_note then  
Redis:set(aykafwra.."Add:Rd:Manager:Vico"..test..msg_chat_id, msg.content.voice_note.voice.remote.id)  
elseif msg.content.audio then
Redis:set(aykafwra.."Add:Rd:Manager:Audio"..test..msg_chat_id, msg.content.audio.audio.remote.id)  
Redis:set(aykafwra.."Add:Rd:Manager:Audioc"..test..msg_chat_id, msg.content.caption.text)  
elseif msg.content.document then
Redis:set(aykafwra.."Add:Rd:Manager:File"..test..msg_chat_id, msg.content.document.document.remote.id)  
elseif msg.content.animation then
Redis:set(aykafwra.."Add:Rd:Manager:Gif"..test..msg_chat_id, msg.content.animation.animation.remote.id)  
elseif msg.content.video_note then
Redis:set(aykafwra.."Add:Rd:Manager:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
elseif msg.content.video then
Redis:set(aykafwra.."Add:Rd:Manager:Video"..test..msg_chat_id, msg.content.video.video.remote.id)  
Redis:set(aykafwra.."Add:Rd:Manager:Videoc"..test..msg_chat_id, msg.content.caption.text)  
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
elseif msg.content.photo.sizes[2].photo.remote.id then
...
Redis:set(aykafwra.."Add:Rd:Manager:Photo"..test..msg_chat_id, idPhoto)  
Redis:set(aykafwra.."Add:Rd:Manager:Photoc"..test..msg_chat_id, msg.content.caption.text)  
end
...
if Redis:get(aykafwra.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(aykafwra.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true1")
Redis:set(aykafwra.."Text:Manager"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:del(aykafwra.."Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(aykafwra.."Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(aykafwra.."Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(aykafwra.."Add:Rd:Manager:Text"..text..msg_chat_id)   
Redis:del(aykafwra.."Add:Rd:Manager:Photo"..text..msg_chat_id)
Redis:del(aykafwra.."Add:Rd:Manager:Photoc"..text..msg_chat_id)
Redis:del(aykafwra.."Add:Rd:Manager:Video"..text..msg_chat_id)
Redis:del(aykafwra.."Add:Rd:Manager:Videoc"..text..msg_chat_id)  
Redis:del(aykafwra.."Add:Rd:Manager:File"..text..msg_chat_id)
Redis:del(aykafwra.."Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(aykafwra.."Add:Rd:Manager:Audio"..text..msg_chat_id)
Redis:del(aykafwra.."Add:Rd:Manager:Audioc"..text..msg_chat_id)
Redis:sadd(aykafwra.."List:Manager"..msg_chat_id.."", text)
...
if text and text:match("^(.*)$") then
if Redis:get(aykafwra.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id.."") == "true2" then
Redis:del(aykafwra.."Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(aykafwra.."Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(aykafwra.."Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(aykafwra.."Add:Rd:Manager:Text"..text..msg_chat_id)   
...
Redis:del(aykafwra.."Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(aykafwra.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(aykafwra.."List:Manager"..msg_chat_id.."", text)
LuaTele.sendText(msg_chat_id,msg_id,"𖥔  تم حذف الرد من الردود ","md",true)  
return false
end
end
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo and msg.sender.user_id ~= aykafwra then
local test = Redis:get(aykafwra.."Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id)
if Redis:get(aykafwra.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(aykafwra.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id)
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(aykafwra.."Add:Rd:Sudo:Text"..test, text)  
elseif msg.content.sticker then   
Redis:set(aykafwra.."Add:Rd:Sudo:stekr"..test, msg.content.sticker.sticker.remote.id)  
elseif msg.content.voice_note then  
Redis:set(aykafwra.."Add:Rd:Sudo:vico"..test, msg.content.voice_note.voice.remote.id)  
elseif msg.content.animation then   
Redis:set(aykafwra.."Add:Rd:Sudo:Gif"..test, msg.content.animation.animation.remote.id)  
elseif msg.content.audio then
Redis:set(aykafwra.."Add:Rd:Sudo:Audio"..test, msg.content.audio.audio.remote.id)  
Redis:set(aykafwra.."Add:Rd:Sudo:Audioc"..test, msg.content.caption.text)  
elseif msg.content.document then
Redis:set(aykafwra.."Add:Rd:Sudo:File"..test, msg.content.document.document.remote.id)  
elseif msg.content.video then
Redis:set(aykafwra.."Add:Rd:Sudo:Video"..test, msg.content.video.video.remote.id)  
Redis:set(aykafwra.."Add:Rd:Sudo:Videoc"..test, msg.content.caption.text)  
elseif msg.content.video_note then
Redis:set(aykafwra.."Add:Rd:Sudo:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
elseif msg.content.photo.sizes[2].photo.remote.id then
...
Redis:set(aykafwra.."Add:Rd:Sudo:Photo"..test, idPhoto)  
Redis:set(aykafwra.."Add:Rd:Sudo:Photoc"..test, msg.content.caption.text)  
end
...
if text and text:match("^(.*)$") then
if Redis:get(aykafwra.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(aykafwra.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id, "true1")
Redis:set(aykafwra.."Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:sadd(aykafwra.."List:Rd:Sudo", text)
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي الرد سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
if text and text:match("^(.*)$") then
if Redis:get(aykafwra.."Set:On"..msg.sender.user_id..":"..msg_chat_id) == "true" then
...
for k,v in pairs(list) do
Redis:del(aykafwra..v..text)
end
Redis:del(aykafwra.."Set:On"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(aykafwra.."List:Rd:Sudo", text)
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔  تم حذف الرد من الردود العامه","md",true)  
end
end
if text then
if not Redis:sismember(aykafwra..'Spam:Group'..msg.sender.user_id,text) then
local anemi = Redis:get(aykafwra.."Add:Rd:Sudo:Gif"..text)   
local veico = Redis:get(aykafwra.."Add:Rd:Sudo:vico"..text)   
local stekr = Redis:get(aykafwra.."Add:Rd:Sudo:stekr"..text)     
local Text = Redis:get(aykafwra.."Add:Rd:Sudo:Text"..text)   
local photo = Redis:get(aykafwra.."Add:Rd:Sudo:Photo"..text)
local photoc = Redis:get(aykafwra.."Add:Rd:Sudo:Photoc"..text)
local video = Redis:get(aykafwra.."Add:Rd:Sudo:Video"..text)
local videoc = Redis:get(aykafwra.."Add:Rd:Sudo:Videoc"..text)
local document = Redis:get(aykafwra.."Add:Rd:Sudo:File"..text)
local audio = Redis:get(aykafwra.."Add:Rd:Sudo:Audio"..text)
local audioc = Redis:get(aykafwra.."Add:Rd:Sudo:Audioc"..text)
local video_note = Redis:get(aykafwra.."Add:Rd:Sudo:video_note"..text)
if Text then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(aykafwra..'Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = msg.Name_Controller
local NumMessageEdit = Redis:get(aykafwra..'Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
...
Redis:sadd(aykafwra.."Spam:Group"..msg.sender.user_id,text) 
end
if photo then
...
if text then
local anemi = Redis:get(aykafwra.."Add:Rd:Manager:Gif"..text..msg_chat_id)   
local veico = Redis:get(aykafwra.."Add:Rd:Manager:Vico"..text..msg_chat_id)   
local stekr = Redis:get(aykafwra.."Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
local Texingt = Redis:get(aykafwra.."Add:Rd:Manager:Text"..text..msg_chat_id)   
local photo = Redis:get(aykafwra.."Add:Rd:Manager:Photo"..text..msg_chat_id)
local photoc = Redis:get(aykafwra.."Add:Rd:Manager:Photoc"..text..msg_chat_id)
local video = Redis:get(aykafwra.."Add:Rd:Manager:Video"..text..msg_chat_id)
local videoc = Redis:get(aykafwra.."Add:Rd:Manager:Videoc"..text..msg_chat_id)  
local document = Redis:get(aykafwra.."Add:Rd:Manager:File"..text..msg_chat_id)
local audio = Redis:get(aykafwra.."Add:Rd:Manager:Audio"..text..msg_chat_id)
local audioc = Redis:get(aykafwra.."Add:Rd:Manager:Audioc"..text..msg_chat_id)
local video_note = Redis:get(aykafwra.."Add:Rd:Manager:video_note"..text..msg_chat_id)
if Texingt then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(aykafwra..'Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg) 
...
------------------------------------------------------------------------------------------------------------
if text and Redis:get(aykafwra..'GetTexting:Devaykafwra'..msg_chat_id..':'..msg.sender.user_id) then
if text == 'الغاء' or text == 'الغاء الامر 𖥔' then 
Redis:del(aykafwra..'GetTexting:Devaykafwra'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'𖥔 تم الغاء حفظ كليشة المطور')
end
Redis:set(aykafwra..'Texting:Devaykafwra',text)
Redis:del(aykafwra..'GetTexting:Devaykafwra'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'𖥔 تم حفظ كليشة المطور')
end
if Redis:get(aykafwra.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n𖥔 تم الغاء امر تعين الايدي عام","md",true)  
Redis:del(aykafwra.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(aykafwra.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(aykafwra.."Set:Id:Groups",text:match("(.*)"))
LuaTele.sendText(msg_chat_id,msg_id,'𖥔 تم تعين الايدي عام',"md",true)  
end
if Redis:get(aykafwra.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n𖥔 تم الغاء امر تعين الايدي","md",true)  
Redis:del(aykafwra.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(aykafwra.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(aykafwra.."Set:Id:Group"..msg.chat_id,text:match("(.*)"))
LuaTele.sendText(msg_chat_id,msg_id,'𖥔 تم تعين الايدي الجديد',"md",true)  
end
if Redis:get(aykafwra.."Change:Name:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر 𖥔' then   
Redis:del(aykafwra.."Change:Name:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n𖥔 تم الغاء امر تغير اسم البوت","md",true)  
end 
Redis:del(aykafwra.."Change:Name:Bot"..msg.sender.user_id) 
Redis:set(aykafwra.."Name:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "𖥔  تم تغير اسم البوت الى - "..text,"md",true)    
end 
if Redis:get(aykafwra.."Change:Start:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر 𖥔' then   
Redis:del(aykafwra.."Change:Start:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n𖥔 تم الغاء امر تغير كليشه start","md",true)  
end 
Redis:del(aykafwra.."Change:Start:Bot"..msg.sender.user_id) 
Redis:set(aykafwra.."Start:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "𖥔  تم تغيير كليشه start - "..text,"md",true)    
end 
if Redis:get(aykafwra.."Game:Smile"..msg.chat_id) then
if text == Redis:get(aykafwra.."Game:Smile"..msg.chat_id) then
Redis:incrby(aykafwra.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(aykafwra.."Game:Smile"..msg.chat_id)
...
if Redis:get(aykafwra.."Game:Monotonous"..msg.chat_id) then
if text == Redis:get(aykafwra.."Game:Monotonous"..msg.chat_id) then
Redis:del(aykafwra.."Game:Monotonous"..msg.chat_id)
Redis:incrby(aykafwra.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(aykafwra.."Game:Countrygof"..msg.chat_id) then
if text == Redis:get(aykafwra.."Game:Countrygof"..msg.chat_id) then
Redis:incrby(aykafwra.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(aykafwra.."Game:Countrygof"..msg.chat_id)
...
if Redis:get(aykafwra.."Game:Riddles"..msg.chat_id) then
if text == Redis:get(aykafwra.."Game:Riddles"..msg.chat_id) then
Redis:incrby(aykafwra.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(aykafwra.."Game:Riddles"..msg.chat_id)
...
if Redis:get(aykafwra.."Game:Meaningof"..msg.chat_id) then
if text == Redis:get(aykafwra.."Game:Meaningof"..msg.chat_id) then
Redis:incrby(aykafwra.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(aykafwra.."Game:Meaningof"..msg.chat_id)
...
if Redis:get(aykafwra.."Game:Reflection"..msg.chat_id) then
if text == Redis:get(aykafwra.."Game:Reflection"..msg.chat_id) then
Redis:incrby(aykafwra.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(aykafwra.."Game:Reflection"..msg.chat_id)
...
if Redis:get(aykafwra.."Game:Estimate"..msg.chat_id..msg.sender.user_id) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 عذرآ لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n","md",true)  
end 
local GETNUM = Redis:get(aykafwra.."Game:Estimate"..msg.chat_id..msg.sender.user_id)
if tonumber(NUM) == tonumber(GETNUM) then
Redis:del(aykafwra.."SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(aykafwra.."Game:Estimate"..msg.chat_id..msg.sender.user_id)
Redis:incrby(aykafwra.."Num:Add:Games"..msg.chat_id..msg.sender.user_id,5)  
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 مبروك فزت ويانه وخمنت الرقم الصحيح\n🚸︙تم اضافة { 5 } من النقاط \n","md",true)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
Redis:incrby(aykafwra.."SADD:NUM"..msg.chat_id..msg.sender.user_id,1)
if tonumber(Redis:get(aykafwra.."SADD:NUM"..msg.chat_id..msg.sender.user_id)) >= 3 then
Redis:del(aykafwra.."SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(aykafwra.."Game:Estimate"..msg.chat_id..msg.sender.user_id)
...
if Redis:get(aykafwra.."Game:Difference"..msg.chat_id) then
if text == Redis:get(aykafwra.."Game:Difference"..msg.chat_id) then 
Redis:del(aykafwra.."Game:Difference"..msg.chat_id)
Redis:incrby(aykafwra.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(aykafwra.."Game:Example"..msg.chat_id) then
if text == Redis:get(aykafwra.."Game:Example"..msg.chat_id) then 
Redis:del(aykafwra.."Game:Example"..msg.chat_id)
Redis:incrby(aykafwra.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if text then
local NewCmmd = Redis:get(aykafwra.."All:Get:Reides:Commands:Group"..text) or Redis:get(aykafwra.."Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(aykafwra..'Channel:Join')}, },}}
...
if tonumber(aykafwra) ~= tonumber(FilesJson.BotId) then
return LuaTele.sendText(msg_chat_id,msg_id,'𖥔 عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end botid
...
Y = Y + 1
Redis:sadd(aykafwra..'Num:User:Pv',v)  
end
X = 0
for GroupId,ListGroup in pairs(FilesJson.GroupsBot) do
X = X + 1
Redis:sadd(aykafwra.."ChekBotAdd",GroupId) 
if ListGroup.President then
for k,v in pairs(ListGroup.President) do
Redis:sadd(aykafwra.."TheBasics:Group"..GroupId,v)
end
end
if ListGroup.Constructor then
for k,v in pairs(ListGroup.Constructor) do
Redis:sadd(aykafwra.."Originators:Group"..GroupId,v)
end
end
if ListGroup.Manager then
for k,v in pairs(ListGroup.Manager) do
Redis:sadd(aykafwra.."Managers:Group"..GroupId,v)
end
end
if ListGroup.Admin then
for k,v in pairs(ListGroup.Admin) do
Redis:sadd(aykafwra.."Addictive:Group"..GroupId,v)
end
end
if ListGroup.Vips then
for k,v in pairs(ListGroup.Vips) do
Redis:sadd(aykafwra.."Distinguished:Group"..GroupId,v)
end
end 
end
...
if text == 'رفع نسخه ايكافورا' and msg.reply_to_message_id ~= 0 then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n*𖥔 هاذا الامر يخص { '..Controller_Num(1)..' }* ',"md",true)  
end
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
...
local File_Id = Message_Reply.content.document.document.remote.id
local Name_File = Message_Reply.content.document.file_name
if tonumber(Name_File:match('(%d+)')) ~= tonumber(aykafwra) then 
return LuaTele.sendText(msg_chat_id,msg_id,'𖥔 عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end Namefile
local File = json:decode(https.request('https://api.telegram.org/bot'..Token..'/getfile?file_id='..File_Id)) 
local download_ = download('https://api.telegram.org/file/bot'..Token..'/'..File.result.file_path,''..Name_File) 
...
Redis:sadd(aykafwra.."ChekBotAdd",idg) 
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
Redis:sadd(aykafwra.."Originators:Group"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
Redis:sadd(aykafwra.."Managers:Group"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
Redis:sadd(aykafwra.."Addictive:Group"..idg,idmod)
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
Redis:sadd(aykafwra.."TheBasics:Group"..idg,idASAS)
end;end
end
return LuaTele.sendText(msg_chat_id,msg_id,'𖥔 تم استرجاع المجموعات من نسخه ايكافورا')
else
...
os.execute('rm -rf aykafwra.lua')
os.execute('wget https://adfrv.zzz.com.ua/beb/aykafwra.lua')
...
Redis:set(aykafwra.."SendBcBot",true) 
...
Redis:set(aykafwra.."LeftBot",true) 
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 تم تفعيل المغادره للمطورين ","md",true)
end
if (Redis:get(aykafwra.."AddSudosNew"..msg_chat_id) == 'true') then
if text == "الغاء" or text == 'الغاء الامر 𖥔' then   
Redis:del(aykafwra.."AddSudosNew"..msg_chat_id)
...
local Groups = Redis:smembers(aykafwra..'ChekBotAdd')  
local UsersBot = Redis:smembers(aykafwra..'Num:User:Pv')  
local Get_Json = '{"BotId": '..aykafwra..','  
if #UsersBot ~= 0 then 
...
local President = Redis:smembers(aykafwra.."TheBasics:Group"..v)
local Constructor = Redis:smembers(aykafwra.."Originators:Group"..v)
local Manager = Redis:smembers(aykafwra.."Managers:Group"..v)
local Admin = Redis:smembers(aykafwra.."Addictive:Group"..v)
local Vips = Redis:smembers(aykafwra.."Distinguished:Group"..v)
if k == 1 then
Get_Json = Get_Json..'"'..v..'":{'
else
Get_Json = Get_Json..',"'..v..'":{'
...
if (Redis:get(aykafwra..'Channel:Redis'..msg_chat_id..msg.sender.user_id) == 'true') then
if text == 'الغاء' or text == 'الغاء الامر 𖥔' then 
Redis:del(aykafwra..'Channel:Redis'..msg_chat_id..msg.sender.user_id)
...
local StatusMember = LuaTele.getChatMember(bana.id,aykafwra).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,"\n𖥔 البوت عضو في القناة يرجى رفع البوت ادمن واعادة وضع الاشتراك ","md",true)  
end
Redis:set(aykafwra..'Channel:Join',ChannelUser) 
...
Redis:set(aykafwra..'Channel:Redis'..msg_chat_id..msg.sender.user_id,true)
...
Redis:del(aykafwra..'Channel:Join')
...
Redis:set(aykafwra..'Num:Add:Bot',text:match("تعين عدد الاعضاء (%d+)$") ) 
...
LuaTele.sendText(msg_chat_id,msg_id,'*𖥔 عدد احصائيات البوت الكامله \n⩹━━━━𖥕aykafwra𖥕━━━━⩺\n𖥔 عدد المجموعات : '..(Redis:scard(aykafwra..'ChekBotAdd') or 0)..'\n𖥔 عدد المشتركين : '..(Redis:scard(aykafwra..'Num:User:Pv') or 0)..'*',"md",true)  
end
...
if Redis:sismember(aykafwra.."ChekBotAdd",msg_chat_id) then
if tonumber(Info_Chats.member_count) < tonumber((Redis:get(aykafwra..'Num:Add:Bot') or 0)) and not msg.ControllerBot then
return LuaTele.sendText(msg_chat_id,msg_id,'𖥔 عدد الاعضاء قليل لا يمكن تفعيل المجموعه  يجب ان يكوم اكثر من :'..Redis:get(aykafwra..'Num:Add:Bot'),"md",true)  
end
...
Redis:sadd(aykafwra.."ChekBotAdd",msg_chat_id)
Redis:set(aykafwra.."Status:Id"..msg_chat_id,true) ;Redis:set(aykafwra.."Status:Reply"..msg_chat_id,true) ;Redis:set(aykafwra.."Status:ReplySudo"..msg_chat_id,true) ;Redis:set(aykafwra.."Status:BanId"..msg_chat_id,true) ;Redis:set(aykafwra.."Status:SetId"..msg_chat_id,true) 
...
if not Redis:get(aykafwra.."BotFree") then
...
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
if not Redis:sismember(aykafwra.."ChekBotAdd",msg_chat_id) then
...
Redis:srem(aykafwra.."ChekBotAdd",msg_chat_id)
...
if chat_type(msg.chat_id) == "GroupBot" and Redis:sismember(aykafwra.."ChekBotAdd",msg_chat_id) then
if text == "ايدي" or text =='id' or text =='Id' or text == 'ID' and msg.reply_to_message_id == 0 then
if not Redis:get(aykafwra.."Status:Id"..msg_chat_id) then
return false
end
...
local TotalMsg = Redis:get(aykafwra..'Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalPhoto = photo.total_count or 0
local TotalEdit = Redis:get(aykafwra..'Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumberGames = Redis:get(aykafwra.."Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
local NumAdd = Redis:get(aykafwra.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0
...
Get_Is_Id = Redis:get(aykafwra.."Set:Id:Groups") or Redis:get(aykafwra.."Set:Id:Group"..msg_chat_id)
if Redis:get(aykafwra.."Status:IdPhoto"..msg_chat_id) then
if Get_Is_Id then
...
local TotalMsg = Redis:get(aykafwra..'Num:Message:User'..msg_chat_id..':'..UserId) or 0
local TotalEdit = Redis:get(aykafwra..'Num:Message:Edit'..msg_chat_id..UserId) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumAdd = Redis:get(aykafwra.."Num:Add:Memp"..msg.chat_id..":"..UserId) or 0
local NumberGames = Redis:get(aykafwra.."Num:Add:Games"..msg.chat_id..UserId) or 0
if Get_Is_Id then
local Get_Is_Id = Get_Is_Id:gsub('#AddMem',NumAdd) 
...
Redis:set(aykafwra.."allM:numdel"..msg.chat_id,Numbardel) 
...
local list = Redis:smembers(aykafwra.."allM"..msg.chat_id)
for k,v in pairs(list) do
local Message = v
if Message then
...
local gmria = Redis:scard(aykafwra.."allM"..msg.chat_id)  
...
Redis:del(aykafwra.."Status:Del:Media"..msg.chat_id)
...
Redis:set(aykafwra.."Status:Del:Media"..msg.chat_id,true)
...
local StatusMember = LuaTele.getChatMember(msg_chat_id,aykafwra).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,'𖥔 البوت عضو في الجروب ',"md",true) 
end
local GetMemberStatus = LuaTele.getChatMember(msg_chat_id,aykafwra).status
if GetMemberStatus.can_change_info then
change_info = '❬ ✅ ❭' else change_info = '❬ ❎ ❭'
end
if GetMemberStatus.can_delete_messages then
...
if not Redis:sismember(aykafwra.."DevelopersQ:Groups",bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم تنزيله مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:srem(aykafwra.."DevelopersQ:Groups",bana.id) 
...
if not Redis:sismember(aykafwra.."HELPBEVQ:Groups",bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم تنزيله مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(aykafwra.."HELPBEVQ:Groups")
Redis:del(aykafwra.."HELPBEVQ:Groups", bana.id)
Redis:del(aykafwra.."id:HELPBEVQ:Groups", bana.id)
...
if not Redis:sismember(aykafwra.."Developers:Groups",bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(aykafwra.."Developers:Groups",bana.id) 
...
if not Redis:sismember(aykafwra.."TheBasics:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(aykafwra.."TheBasics:Group"..msg_chat_id,bana.id) 
...
if not Redis:sismember(aykafwra.."Originators:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(aykafwra.."Originators:Group"..msg_chat_id,bana.id) 
...
if not Redis:sismember(aykafwra.."Managers:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(aykafwra.."Managers:Group"..msg_chat_id,bana.id) 
...
if not Redis:sismember(aykafwra.."Addictive:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(aykafwra.."Addictive:Group"..msg_chat_id,bana.id) 
...
if not Redis:sismember(aykafwra.."Distinguished:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(aykafwra.."Distinguished:Group"..msg_chat_id,bana.id) 
...
if not Redis:sismember(aykafwra.."DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(aykafwra.."DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(aykafwra.."HELPBEVQ:Groups",Message_Reply.sender.user_id) then
...
Redis:del(aykafwra.."HELPBEVQ:Groups")
Redis:del(aykafwra.."HELPBEVQ:Groups", Message_Reply.sender.user_id)
Redis:del(aykafwra.."id:HELPBEVQ:Groups", Message_Reply.sender.user_id)
...
if not Redis:sismember(aykafwra.."Developers:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(aykafwra.."Developers:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(aykafwra.."TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(aykafwra.."TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(aykafwra.."Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(aykafwra.."Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(aykafwra.."Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(aykafwra.."Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(aykafwra.."Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(aykafwra.."Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(aykafwra.."Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(aykafwra.."Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(aykafwra.."DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"𖥔 تم تنزيله مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:srem(aykafwra.."DevelopersQ:Groups",UserId) 
...
if not Redis:sismember(aykafwra.."HELPBEVQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"𖥔 تم تنزيله مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(aykafwra.."HELPBEVQ:Groups")
Redis:del(aykafwra.."HELPBEVQ:Groups", UserId)
Redis:del(aykafwra.."id:HELPBEVQ:Groups", UserId)
...
if not Redis:sismember(aykafwra.."Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"𖥔 تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(aykafwra.."Developers:Groups",UserId) 
...
if not Redis:sismember(aykafwra.."TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"𖥔 تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(aykafwra.."TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(aykafwra.."Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"𖥔 تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(aykafwra.."Originators:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(aykafwra.."Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"𖥔 تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(aykafwra.."Managers:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(aykafwra.."Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"𖥔 تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(aykafwra.."Addictive:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(aykafwra.."Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"𖥔 تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(aykafwra.."Distinguished:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(aykafwra.."HELPBEVQ:Groups",bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:del(aykafwra.."HELPBEVQ:Groups")
Redis:sadd(aykafwra.."HELPBEVQ:Groups", UserId)
Redis:set(aykafwra.."id:HELPBEVQ:Groups", UserId)
...
if Redis:sismember(aykafwra.."Developers:Groups",bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(aykafwra.."Developers:Groups",bana.id) 
...
if Redis:sismember(aykafwra.."TheBasics:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(aykafwra.."TheBasics:Group"..msg_chat_id,bana.id) 
...
if Redis:sismember(aykafwra.."Originators:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(aykafwra.."Originators:Group"..msg_chat_id,bana.id) 
...
if Redis:sismember(aykafwra.."Managers:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(aykafwra.."Managers:Group"..msg_chat_id,bana.id) 
...
if not msg.Originators and not Redis:get(aykafwra.."Status:SetId"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 تم تعطيل (الرفع) من قبل المنشئين","md",true)
end 
if Redis:sismember(aykafwra.."Addictive:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(aykafwra.."Addictive:Group"..msg_chat_id,bana.id) 
...
if Redis:sismember(aykafwra.."Distinguished:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(aykafwra.."Distinguished:Group"..msg_chat_id,bana.id) 
...
if Redis:sismember(aykafwra.."DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(aykafwra.."DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(aykafwra.."HELPBEVQ:Groups",Message_Reply.sender.user_id) then
...
Redis:del(aykafwra.."HELPBEVQ:Groups")
Redis:sadd(aykafwra.."HELPBEVQ:Groups", Message_Reply.sender.user_id)
Redis:set(aykafwra.."id:HELPBEVQ:Groups", Message_Reply.sender.user_id)
...
if Redis:sismember(aykafwra.."Developers:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(aykafwra.."Developers:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(aykafwra.."TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(aykafwra.."TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(aykafwra.."Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(aykafwra.."Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(aykafwra.."Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(aykafwra.."Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(aykafwra.."Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(aykafwra.."Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(aykafwra.."Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(aykafwra.."Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(aykafwra.."HELPBEVQ:Groups",UserId) then
...
if Redis:sismember(aykafwra.."Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"𖥔 تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(aykafwra.."Developers:Groups",UserId) 
...
if Redis:sismember(aykafwra.."TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"𖥔 تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(aykafwra.."TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(aykafwra.."Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"𖥔 تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(aykafwra.."Originators:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(aykafwra.."Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"𖥔 تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(aykafwra.."Managers:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(aykafwra.."Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"𖥔 تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(aykafwra.."Addictive:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(aykafwra.."Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"𖥔 تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(aykafwra.."Distinguished:Group"..msg_chat_id,UserId[2]) 
...
Redis:set(aykafwra.."Developer:Bot:Reply"..msg.chat_id,Teext)
...
Redis:set(aykafwra.."President:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(aykafwra.."Constructor:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(aykafwra.."PresidentQ:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(aykafwra.."Manager:Group:Reply"..msg.chat_id,Teext) 
...
Redis:set(aykafwra.."Admin:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(aykafwra.."Vip:Group:Reply"..msg.chat_id,Teext)
...
local Info_Members = Redis:smembers(aykafwra.."DevelopersQ:Groups") 
...
local Info_Members = Redis:smembers(aykafwra.."Developers:Groups") 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 لا يوجد مطورين حاليا , ","md",true)  
end
...
local Info_Members = Redis:smembers(aykafwra.."TheBasicsQ:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(aykafwra.."TheBasics:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(aykafwra.."Originators:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(aykafwra.."Managers:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(aykafwra.."Addictive:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(aykafwra.."Distinguished:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(aykafwra.."BanAll:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(aykafwra.."ktmAll:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(aykafwra.."BanGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(aykafwra.."SilentGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
Redis:set(aykafwra.."Status:Link"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 تم تفعيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:set(aykafwra.."Status:Welcome"..msg_chat_id,true) 
...
Redis:set(aykafwra.."Status:IdPhoto"..msg_chat_id,true) 
...
Redis:set(aykafwra.."Status:Reply"..msg_chat_id,true) 
...
Redis:set(aykafwra.."Status:ReplySudo"..msg_chat_id,true) 
...
Redis:set(aykafwra.."Status:BanId"..msg_chat_id,true) 
...
Redis:set(aykafwra.."BotFree",true) 
...
Redis:set(aykafwra.."TwaslBot",true) 
...
Redis:del(aykafwra.."Status:Id"..msg_chat_id) 
...
Redis:del(aykafwra.."Status:IdPhoto"..msg_chat_id) 
...
Redis:del(aykafwra.."Status:Reply"..msg_chat_id) 
...
Redis:del(aykafwra.."Status:ReplySudo"..msg_chat_id) 
...
Redis:del(aykafwra.."Status:BanId"..msg_chat_id) 
...
if ChannelJoin(msg) == false then
local chinfo = Redis:get(aykafwra.."ch:admin")
...
if not msg.Originators and not Redis:get(aykafwra.."Status:BanId"..msg_chat_id) then
...
if Redis:sismember(aykafwra.."BanGroup:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(aykafwra.."BanGroup:Group"..msg_chat_id,bana.id) 
LuaTele.setChatMemberStatus(msg.chat_id,bana.id,'banned',0)
...
if not Redis:sismember(aykafwra.."BanGroup:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم الغاء حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:srem(aykafwra.."BanGroup:Group"..msg_chat_id,bana.id) 
LuaTele.setChatMemberStatus(msg.chat_id,bana.id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(aykafwra.."SilentGroup:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم كتمه في الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(aykafwra.."SilentGroup:Group"..msg_chat_id,bana.id) 
...
if not Redis:sismember(aykafwra.."SilentGroup:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم الغاء كتمه من الجروب ").Reply,"md",true)  
else
Redis:srem(aykafwra.."SilentGroup:Group"..msg_chat_id,bana.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم الغاء كتمه من الجروب ").Reply,"md",true)  
end
end
...
if Redis:sismember(aykafwra.."BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(aykafwra.."BanAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(aykafwra.."BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(aykafwra.."BanAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(aykafwra.."ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(aykafwra.."ktmAll:Groups",Message_Reply.sender.user_id) 
if ban.first_name then
baniusername = '*المستخدم :- *['..ban.first_name..'](tg://user?id='..ban.id..')*\nتم كتمه في الجروب\nمن قبل :- *['..bain.first_name..'](tg://user?id='..bain.id..')*\n*'
else
baniusername = 'لا يوجد'
...
if not Redis:sismember(aykafwra.."ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(aykafwra.."ktmAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(aykafwra.."BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(aykafwra.."BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'banned',0)
if ban.first_name then
baniusername = '*المستخدم :- *['..ban.first_name..'](tg://user?id='..ban.id..')*\n𖥔 تم حظره من الجروب\nمن قبل :- *['..bain.first_name..'](tg://user?id='..bain.id..')*\n*'
else
...
if not Redis:sismember(aykafwra.."BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(aykafwra.."BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(aykafwra.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(aykafwra.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
if ban.first_name then
baniusername = '*المستخدم :- *['..ban.first_name..'](tg://user?id='..ban.id..')*\nتم كتمه في الجروب\nمن قبل :- *['..bain.first_name..'](tg://user?id='..bain.id..')*\n*'
else
baniusername = 'لا يوجد'
...
if not Redis:sismember(aykafwra.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(aykafwra.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"𖥔 تم الغاء كتمه من الجروب ").Reply,"md",true)  
end
end
...
Redis:sadd(aykafwra.."BanAll:Groups",UserId) 
...
if Redis:sismember(aykafwra.."BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"𖥔 تم حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(aykafwra.."BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'banned',0)
if ban.first_name then
...
if not Redis:sismember(aykafwra.."BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"𖥔 تم الغاء حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:srem(aykafwra.."BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(aykafwra.."SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"𖥔 تم كتمه في الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(aykafwra.."SilentGroup:Group"..msg_chat_id,UserId) 
if ban.first_name then
baniusername = '*المستخدم :- *['..ban.first_name..'](tg://user?id='..ban.id..')*\n𖥔 تم كتمه في الجروب\nمن قبل :- *['..bain.first_name..'](tg://user?id='..bain.id..')*\n*'
else
baniusername = 'لا يوجد'
...
if not Redis:sismember(aykafwra.."SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"𖥔 تم الغاء كتمه من الجروب ").Reply,"md",true)  
else
Redis:srem(aykafwra.."SilentGroup:Group"..msg_chat_id,UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"𖥔 تم الغاء كتمه من الجروب ").Reply,"md",true)  
end
end
...
if text == "نزلني" then
if not Redis:get(aykafwra.."Status:remMe"..msg_chat_id) then
...
Rink = 1
elseif Redis:sismember(aykafwra.."DevelopersQ:Groups",msg.sender.user_id)  then
Rink = 2
elseif Redis:sismember(aykafwra.."Developers:Groups",msg.sender.user_id)  then
Rink = 3
elseif Redis:sismember(aykafwra.."TheBasicsQ:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 4
elseif Redis:sismember(aykafwra.."TheBasics:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 5
elseif Redis:sismember(aykafwra.."Originators:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 6
elseif Redis:sismember(aykafwra.."Managers:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 7
elseif Redis:sismember(aykafwra.."Addictive:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 8
elseif Redis:sismember(aykafwra.."Distinguished:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 9
else
Rink = 10
end
...
Redis:srem(aykafwra.."Addictive:Group"..msg_chat_id, msg.sender.user_id)
Redis:srem(aykafwra.."Distinguished:Group"..msg_chat_id, msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 تم تنزيلك من الادمنيه والمميزين ","md",true) 
end
end

if text == "اطردني" or text == "طردني" then
if not Redis:get(aykafwra.."Status:KickMe"..msg_chat_id) then
...
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(aykafwra.."TheBasics:Group"..msg_chat_id,v.member_id.user_id) 
x = x + 1
else
Redis:sadd(aykafwra.."Addictive:Group"..msg_chat_id,v.member_id.user_id) 
y = y + 1
end
end
end
...
local TestText = "  ❲ Developers aykafwra  ❳\n— — — — — — — — —\n 𖥔*Dev Name* :  [".. ban.first_name.."](tg://user?id="..Sudo_Id..")\n𖥔 *Dev Bio* : [❲ "..Bio.." ❳]"
local msg_id = msg.id/2097152/0.5 
...
if text == 'المبرمج زيزو' or text == 'زيزو' or text == 'زياد' then  
local UserId_Info = LuaTele.searchPublicChat("X_x_Z_i_a_d_x_X")
...
if text == 'المبرمج زياد' or text == 'زياد' or text == 'زيزو' then  
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
local bains = LuaTele.getUser(msg.sender.user_id)
if bains.first_name then
...
LuaTele.sendText(1878261073,0,'*\n𖥔 مرحباً عزيزي المبرمج زياد \nشخص ما يحتاج الي مساعده\n⩹━━━━𖥕aykafwra𖥕━━━━⩺\n𖥔 اسمه :- '..klajq..' \n𖥔 ايديه :-  : '..msg.sender.user_id..'\n𖥔 - معرفة '..basgk..' \n*',"md",false, false, false, false, reply_markup)
end
if text == 'المساعد' or text == 'مساعد' then   
local id = Redis:get(aykafwra.."id:HELPBEVQ:Groups")
...
local Added_Me = Redis:get(aykafwra.."Who:Added:Me"..msg.sender.user_id..':'..msg.sender.user_id)
if Added_Me then 
...
if not Redis:get(aykafwra.."rb:bna"..msg_chat_id) then
...
if Redis:get(aykafwra.."lockalllll"..msg_chat_id) == "off" then
...
Redis:sadd(aykafwra.."cleaner"..msg_chat_id,msg_id)
end
if text == "مسح الميديا" then 
if not msg.Managers then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*𖥔 هاذا الامر يخص⦗ '..Controller_Num(6)..' ⦘* ',"md",true)  
end
local list = Redis:smembers(aykafwra.."cleaner"..msg_chat_id)
if #list == 0 then 
...
Redis:del(aykafwra.."cleaner"..msg_chat_id)
...
---زخرفة ----
if Redis:get(aykafwra.."zhrfa"..msg.sender.user_id) == "sendzh" then
...
LuaTele.sendText(msg_chat_id,msg_id,t,"md",true) 
Redis:del(aykafwra.."zhrfa"..msg.sender.user_id) 
end



if text == "جمالي" or text == 'نسبه جمالي' then
if Redis:get(aykafwra.."Status:gamle"..msg.chat_id) then
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
...
if Redis:get(aykafwra.."Status:kool"..msg.chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,m,"md",true) 
end
end
if text == "صورتي" then
if Redis:get(aykafwra.."Status:photo"..msg.chat_id) then
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
local ban = LuaTele.getUser(msg.sender.user_id)
...
if not msg.ControllerBot and not Redis:set(aykafwra.."LeftBot") then
...
Redis:set(aykafwra.."Lock:text"..msg_chat_id,true) 
...
Redis:set(aykafwra.."Lock:AddMempar"..msg_chat_id,"kick")  
...
Redis:set(aykafwra.."Lock:Join"..msg_chat_id,"kick")  
...
Redis:set(aykafwra.."Lock:Bot:kick"..msg_chat_id,"del")  
...
Redis:set(aykafwra.."Lock:Bot:kick"..msg_chat_id,"kick")  
...
Redis:set(aykafwra.."Lock:tagservr"..msg_chat_id,true)  
...
Redis:set(aykafwra.."lockalllll"..msg_chat_id,"off")
...
Redis:set(aykafwra.."lockalllll"..msg_chat_id,"on")
...
Redis:set(aykafwra.."lockpin"..msg_chat_id,(LuaTele.getChatPinnedMessage(msg_chat_id).id or true)) 
...
Redis:set(aykafwra.."Lock:edit"..msg_chat_id,true) 
...
Redis:set(aykafwra.."Lock:tagservrbot"..msg_chat_id,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(aykafwra..''..lock..msg_chat_id,"del")    
end
...
Redis:del(aykafwra.."Lock:AddMempar"..msg_chat_id)  
...
Redis:del(aykafwra.."Lock:text"..msg_chat_id)  
...
Redis:del(aykafwra.."Lock:Join"..msg_chat_id)  
...
Redis:del(aykafwra.."Lock:Bot:kick"..msg_chat_id)  
...
Redis:del(aykafwra.."Lock:tagservr"..msg_chat_id)  
...
Redis:del(aykafwra.."lockpin"..msg_chat_id)  
...
Redis:del(aykafwra.."Lock:edit"..msg_chat_id) 
...
Redis:del(aykafwra.."Lock:tagservrbot"..msg_chat_id)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:del(aykafwra..''..lock..msg_chat_id)    
end
...
Redis:hset(aykafwra.."Spam:Group:User"..msg_chat_id ,"Spam:User","del")  
...
Redis:hset(aykafwra.."Spam:Group:User"..msg_chat_id ,"Spam:User","keed")  
...
Redis:hset(aykafwra.."Spam:Group:User"..msg_chat_id ,"Spam:User","mute")  
...
Redis:hset(aykafwra.."Spam:Group:User"..msg_chat_id ,"Spam:User","kick")  
...
Redis:hdel(aykafwra.."Spam:Group:User"..msg_chat_id ,"Spam:User")  
...
Redis:set(aykafwra.."Lock:Link"..msg_chat_id,"del")  
...
Redis:set(aykafwra.."Lock:Link"..msg_chat_id,"ked")  
...
Redis:set(aykafwra.."Lock:Link"..msg_chat_id,"ktm")  
...
Redis:set(aykafwra.."Lock:Link"..msg_chat_id,"kick")  
...
Redis:del(aykafwra.."Lock:Link"..msg_chat_id)  
...
Redis:set(aykafwra.."Lock:User:Name"..msg_chat_id,"del")  
...
Redis:set(aykafwra.."Lock:User:Name"..msg_chat_id,"ked")  
...
Redis:set(aykafwra.."Lock:User:Name"..msg_chat_id,"ktm")  
...
Redis:set(aykafwra.."Lock:User:Name"..msg_chat_id,"kick")  
...
Redis:del(aykafwra.."Lock:User:Name"..msg_chat_id)  
...
Redis:set(aykafwra.."Lock:hashtak"..msg_chat_id,"del")  
...
Redis:set(aykafwra.."Lock:hashtak"..msg_chat_id,"ked")  
...
Redis:set(aykafwra.."Lock:hashtak"..msg_chat_id,"ktm")  
...
Redis:set(aykafwra.."Lock:hashtak"..msg_chat_id,"kick")  
...
Redis:del(aykafwra.."Lock:hashtak"..msg_chat_id)  
...
Redis:set(aykafwra.."Lock:Cmd"..msg_chat_id,"del")  
...
Redis:set(aykafwra.."Lock:Cmd"..msg_chat_id,"ked")  
...
Redis:set(aykafwra.."Lock:Cmd"..msg_chat_id,"ktm")  
...
Redis:set(aykafwra.."Lock:Cmd"..msg_chat_id,"kick")  
...
Redis:set(aykafwra..'lock:Fshar'..msg.chat_id,true) 
...
Redis:set(aykafwra..'lock:Cht'..msg.chat_id,true) 
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"𖥔 تم قفـل السب").Lock,"md",true)  
end
...
Redis:set(aykafwra..'lock:Fars'..msg.chat_id,true) 
...
Redis:del(aykafwra..'lock:Fshar'..msg.chat_id) 
...
Redis:del(aykafwra..'lock:Cht'..msg.chat_id) 
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"𖥔 تم فتح السب").unLock,"md",true)  
end
...
Redis:del(aykafwra..'lock:Fars'..msg.chat_id) 
...
Redis:del(aykafwra.."Lock:Cmd"..msg_chat_id)  
...
Redis:set(aykafwra.."Lock:Photo"..msg_chat_id,"del")  
...
Redis:set(aykafwra.."Lock:Photo"..msg_chat_id,"ked")  
...
Redis:set(aykafwra.."Lock:Photo"..msg_chat_id,"ktm")  
...
Redis:set(aykafwra.."Lock:Photo"..msg_chat_id,"kick")  
...
Redis:del(aykafwra.."Lock:Photo"..msg_chat_id)  
...
Redis:set(aykafwra.."Lock:Video"..msg_chat_id,"del")  
...
Redis:set(aykafwra.."Lock:Video"..msg_chat_id,"ked")  
...
Redis:set(aykafwra.."Lock:Video"..msg_chat_id,"ktm")  
...
Redis:set(aykafwra.."Lock:Video"..msg_chat_id,"kick")  
...
Redis:del(aykafwra.."Lock:Video"..msg_chat_id)  
...
Redis:set(aykafwra.."Lock:Animation"..msg_chat_id,"del")  
...
Redis:set(aykafwra.."Lock:Animation"..msg_chat_id,"ked")  
...
Redis:set(aykafwra.."Lock:Animation"..msg_chat_id,"ktm")  
...
Redis:set(aykafwra.."Lock:Animation"..msg_chat_id,"kick")  
...
Redis:del(aykafwra.."Lock:Animation"..msg_chat_id)  
...
Redis:set(aykafwra.."Lock:geam"..msg_chat_id,"del")  
...
Redis:set(aykafwra.."Lock:geam"..msg_chat_id,"ked")  
...
Redis:set(aykafwra.."Lock:geam"..msg_chat_id,"ktm")  
...
Redis:set(aykafwra.."Lock:geam"..msg_chat_id,"kick")  
...
Redis:del(aykafwra.."Lock:geam"..msg_chat_id)  
...
Redis:set(aykafwra.."Lock:Audio"..msg_chat_id,"del")  
...
Redis:set(aykafwra.."Lock:Audio"..msg_chat_id,"ked")  
...
Redis:set(aykafwra.."Lock:Audio"..msg_chat_id,"ktm")  
...
Redis:set(aykafwra.."Lock:Audio"..msg_chat_id,"kick")  
...
Redis:del(aykafwra.."Lock:Audio"..msg_chat_id)  
...
Redis:set(aykafwra.."Lock:vico"..msg_chat_id,"del")  
...
Redis:set(aykafwra.."Lock:vico"..msg_chat_id,"ked")  
...
Redis:set(aykafwra.."Lock:vico"..msg_chat_id,"ktm")  
...
Redis:set(aykafwra.."Lock:vico"..msg_chat_id,"kick")  
...
Redis:del(aykafwra.."Lock:vico"..msg_chat_id)  
...
Redis:set(aykafwra.."Lock:Keyboard"..msg_chat_id,"del")  
...
Redis:set(aykafwra.."Lock:Keyboard"..msg_chat_id,"ked")  
...
Redis:set(aykafwra.."Lock:Keyboard"..msg_chat_id,"ktm")  
...
Redis:set(aykafwra.."Lock:Keyboard"..msg_chat_id,"kick")  
...
Redis:del(aykafwra.."Lock:Keyboard"..msg_chat_id)  
...
Redis:set(aykafwra.."Lock:Sticker"..msg_chat_id,"del")  
...
Redis:set(aykafwra.."Lock:Sticker"..msg_chat_id,"ked")  
...
Redis:set(aykafwra.."Lock:Sticker"..msg_chat_id,"ktm")  
...
Redis:set(aykafwra.."Lock:Sticker"..msg_chat_id,"kick")  
...
Redis:del(aykafwra.."Lock:Sticker"..msg_chat_id)  
...
Redis:set(aykafwra.."Lock:forward"..msg_chat_id,"del")  
...
Redis:set(aykafwra.."Lock:forward"..msg_chat_id,"ked")  
...
Redis:set(aykafwra.."Lock:forward"..msg_chat_id,"ktm")  
...
Redis:set(aykafwra.."Lock:forward"..msg_chat_id,"kick")  
...
Redis:del(aykafwra.."Lock:forward"..msg_chat_id)  
...
Redis:set(aykafwra.."Lock:Document"..msg_chat_id,"del")  
...
Redis:set(aykafwra.."Lock:Document"..msg_chat_id,"ked")  
...
Redis:set(aykafwra.."Lock:Document"..msg_chat_id,"ktm")  
...
Redis:set(aykafwra.."Lock:Document"..msg_chat_id,"kick")  
...
Redis:del(aykafwra.."Lock:Document"..msg_chat_id)  
...
Redis:set(aykafwra.."Lock:Unsupported"..msg_chat_id,"del")  
...
Redis:set(aykafwra.."Lock:Unsupported"..msg_chat_id,"ked")  
...
Redis:set(aykafwra.."Lock:Unsupported"..msg_chat_id,"ktm")  
...
Redis:set(aykafwra.."Lock:Unsupported"..msg_chat_id,"kick")  
...
Redis:del(aykafwra.."Lock:Unsupported"..msg_chat_id)  
...
Redis:set(aykafwra.."Lock:Markdaun"..msg_chat_id,"del")  
...
Redis:set(aykafwra.."Lock:Markdaun"..msg_chat_id,"ked")  
...
Redis:set(aykafwra.."Lock:Markdaun"..msg_chat_id,"ktm")  
...
Redis:set(aykafwra.."Lock:Markdaun"..msg_chat_id,"kick")  
...
Redis:del(aykafwra.."Lock:Markdaun"..msg_chat_id)  
...
Redis:set(aykafwra.."Lock:Contact"..msg_chat_id,"del")  
...
Redis:set(aykafwra.."Lock:Contact"..msg_chat_id,"ked")  
...
Redis:set(aykafwra.."Lock:Contact"..msg_chat_id,"ktm")  
...
Redis:set(aykafwra.."Lock:Contact"..msg_chat_id,"kick")  
...
Redis:del(aykafwra.."Lock:Contact"..msg_chat_id)  
...
Redis:set(aykafwra.."Lock:Spam"..msg_chat_id,"del")  
...
Redis:set(aykafwra.."Lock:Spam"..msg_chat_id,"ked")  
...
Redis:set(aykafwra.."Lock:Spam"..msg_chat_id,"ktm")  
...
Redis:set(aykafwra.."Lock:Spam"..msg_chat_id,"kick")  
...
Redis:del(aykafwra.."Lock:Spam"..msg_chat_id)  
...
Redis:set(aykafwra.."Lock:Inlen"..msg_chat_id,"del")  
...
Redis:set(aykafwra.."Lock:Inlen"..msg_chat_id,"ked")  
...
Redis:set(aykafwra.."Lock:Inlen"..msg_chat_id,"ktm")  
...
Redis:set(aykafwra.."Lock:Inlen"..msg_chat_id,"kick")  
...
Redis:del(aykafwra.."Lock:Inlen"..msg_chat_id)  
...
Redis:setex(aykafwra.."Set:Link"..msg_chat_id..""..msg.sender.user_id,120,true) 
...
Redis:setex(aykafwra.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id, 120, true)  
...
if not Redis:get(aykafwra.."Status:Welcome"..msg_chat_id) then
...
Redis:del(aykafwra.."Welcome:Group"..msg_chat_id) 
...
Redis:setex(aykafwra.."Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:del(aykafwra.."Group:Rules"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 تم ازالة قوانين الجروب","md",true)    
end
if text == "القوانين" then 
local Rules = Redis:get(aykafwra.."Group:Rules" .. msg_chat_id)   
if Rules then     
...
Redis:setex(aykafwra.."Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(aykafwra.."Chat:Photo"..msg_chat_id..":"..msg.sender.user_id,true) 
...
local list = Redis:smembers(aykafwra.."List:Filter"..msg_chat_id)  
if #list == 0 then  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
Redis:del(aykafwra.."Filter:Group:"..v..msg_chat_id)  
Redis:srem(aykafwra.."List:Filter"..msg_chat_id,v)  
end  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
local Text_Filter = Redis:get(aykafwra.."Filter:Group:"..v..msg_chat_id)   
...
Redis:set(aykafwra..'FilterText'..msg_chat_id..':'..msg.sender.user_id,'true')
...
Redis:set(aykafwra..'FilterText'..msg_chat_id..':'..msg.sender.user_id,'DelFilter')
return LuaTele.sendText(msg_chat_id,msg_id,'\n*𖥔 ارسل الان { ملصق ,متحركه ,صوره ,رساله } *',"md",true)  
end
...
Redis:set(aykafwra.."All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
Redis:set(aykafwra.."All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
local list = Redis:smembers(aykafwra.."All:Command:List:Group")
for k,v in pairs(list) do
Redis:del(aykafwra.."All:Get:Reides:Commands:Group"..v)
Redis:del(aykafwra.."All:Command:List:Group")
end
...
for k,v in pairs(list) do
Commands = Redis:get(aykafwra.."All:Get:Reides:Commands:Group"..v)
if Commands then 
...
Redis:set(aykafwra.."Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 الان ارسل لي الامر القديم ...","md",true)
end
...
Redis:set(aykafwra.."Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 ارسل الان الامر الذي قمت بوضعه مكان الامر القديم","md",true)
end
...
local list = Redis:smembers(aykafwra.."Command:List:Group"..msg_chat_id)
for k,v in pairs(list) do
Redis:del(aykafwra.."Get:Reides:Commands:Group"..msg_chat_id..":"..v)
Redis:del(aykafwra.."Command:List:Group"..msg_chat_id)
end
...
for k,v in pairs(list) do
Commands = Redis:get(aykafwra.."Get:Reides:Commands:Group"..msg_chat_id..":"..v)
if Commands then 
Command = Command..""..k..": ("..v..") ← {"..Commands.."}\n"
else
Command = Command..""..k..": ("..v..") \n"
...
if Redis:get(aykafwra.."Status:Link"..msg.chat_id) then
Statuslink = '❬ ✅ ❭' else Statuslink = '❬ ❎ ❭'
end
if Redis:get(aykafwra.."Status:Welcome"..msg.chat_id) then
StatusWelcome = '❬ ✅ ❭' else StatusWelcome = '❬ ❎ ❭'
end
if Redis:get(aykafwra.."Status:Id"..msg.chat_id) then
StatusId = '❬ ✅ ❭' else StatusId = '❬ ❎ ❭'
end
if Redis:get(aykafwra.."Status:IdPhoto"..msg.chat_id) then
StatusIdPhoto = '❬ ✅ ❭' else StatusIdPhoto = '❬ ❎ ❭'
end
if Redis:get(aykafwra.."Status:Reply"..msg.chat_id) then
StatusReply = '❬ ✅ ❭' else StatusReply = '❬ ❎ ❭'
end
if Redis:get(aykafwra.."Status:ReplySudo"..msg.chat_id) then
StatusReplySudo = '❬ ✅ ❭' else StatusReplySudo = '❬ ❎ ❭'
end
if Redis:get(aykafwra.."Status:BanId"..msg.chat_id)  then
StatusBanId = '❬ ✅ ❭' else StatusBanId = '❬ ❎ ❭'
end
if Redis:get(aykafwra.."Status:SetId"..msg.chat_id) then
StatusSetId = '❬ ✅ ❭' else StatusSetId = '❬ ❎ ❭'
end
if Redis:get(aykafwra.."Status:Games"..msg.chat_id) then
StatusGames = '❬ ✅ ❭' else StatusGames = '❬ ❎ ❭'
end
if Redis:get(aykafwra.."Status:KickMe"..msg.chat_id) then
Statuskickme = '❬ ✅ ❭' else Statuskickme = '❬ ❎ ❭'
end
if Redis:get(aykafwra.."Status:AddMe"..msg.chat_id) then
...
Rink = 1
elseif Redis:sismember(aykafwra.."DevelopersQ:Groups",Message_Reply.sender.user_id)  then
Rink = 2
elseif Redis:sismember(aykafwra.."Developers:Groups",Message_Reply.sender.user_id)  then
Rink = 3
elseif Redis:sismember(aykafwra.."TheBasicsQ:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 4
elseif Redis:sismember(aykafwra.."TheBasics:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 5
elseif Redis:sismember(aykafwra.."Originators:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 6
elseif Redis:sismember(aykafwra.."Managers:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 7
elseif Redis:sismember(aykafwra.."Addictive:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 8
elseif Redis:sismember(aykafwra.."Distinguished:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 9
else
Rink = 10
end
...
Rink = 1
elseif Redis:sismember(aykafwra.."DevelopersQ:Groups",bana.id)  then
Rink = 2
elseif Redis:sismember(aykafwra.."Developers:Groups",bana.id)  then
Rink = 3
elseif Redis:sismember(aykafwra.."TheBasicsQ:Group"..msg_chat_id, bana.id) then
Rink = 4
elseif Redis:sismember(aykafwra.."TheBasics:Group"..msg_chat_id, bana.id) then
Rink = 5
elseif Redis:sismember(aykafwra.."Originators:Group"..msg_chat_id, bana.id) then
Rink = 6
elseif Redis:sismember(aykafwra.."Managers:Group"..msg_chat_id, bana.id) then
Rink = 7
elseif Redis:sismember(aykafwra.."Addictive:Group"..msg_chat_id, bana.id) then
Rink = 8
elseif Redis:sismember(aykafwra.."Distinguished:Group"..msg_chat_id, bana.id) then
Rink = 9
else
Rink = 10
end
...
Redis:del(aykafwra..'Num:Message:User'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'𖥔 تم مسح جميع رسائلك ',"md",true)  
elseif text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' then
Redis:del(aykafwra..'Num:Message:Edit'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'𖥔 تم مسح جميع تعديلاتك ',"md",true)  
elseif text == 'مسح جهاتي' then
Redis:del(aykafwra..'Num:Add:Memp'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'𖥔 تم مسح جميع جهاتك المضافه ',"md",true)  
elseif text == 'رسائلي' then
LuaTele.sendText(msg_chat_id,msg_id,'𖥔 عدد رسائلك هنا *~ '..(Redis:get(aykafwra..'Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 1)..'*',"md",true)  
elseif text == 'سحكاتي' or text == 'تعديلاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'𖥔 عدد التعديلات هنا *~ '..(Redis:get(aykafwra..'Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)..'*',"md",true)  
elseif text == 'جهاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'𖥔 عدد جهاتك المضافه هنا *~ '..(Redis:get(aykafwra.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0)..'*',"md",true)  
...
Redis:setex(aykafwra.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
𖥔 ارسل الان النص
𖥔 يمكنك اضافه :
...
Redis:del(aykafwra.."Set:Id:Groups")
...
Redis:setex(aykafwra.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
𖥔 ارسل الان النص
𖥔 يمكنك اضافه :
𖥔 `#username` » اسم المستخدم
...
Redis:del(aykafwra.."Set:Id:Group"..msg.chat_id)
...
Redis:del(aykafwra.."DevelopersQ:Groups") 
...
Redis:del(aykafwra.."Developers:Groups") 
...
Redis:del(aykafwra.."TheBasics:Group"..msg_chat_id) 
...
Redis:del(aykafwra.."Originators:Group"..msg_chat_id) 
...
Redis:del(aykafwra.."Managers:Group"..msg_chat_id) 
...
Redis:del(aykafwra.."Addictive:Group"..msg_chat_id) 
...
Redis:del(aykafwra.."Distinguished:Group"..msg_chat_id) 
...
Redis:del(aykafwra.."BanAll:Groups") 
...
Redis:del(aykafwra.."ktmAll:Groups") 
...
Redis:del(aykafwra.."BanGroup:Group"..msg_chat_id) 
...
Redis:del(aykafwra.."SilentGroup:Group"..msg_chat_id) 
...
local list = Redis:smembers(aykafwra.."List:Manager"..msg_chat_id.."")
for k,v in pairs(list) do
Redis:del(aykafwra.."Add:Rd:Manager:Gif"..v..msg_chat_id)   
Redis:del(aykafwra.."Add:Rd:Manager:Vico"..v..msg_chat_id)   
Redis:del(aykafwra.."Add:Rd:Manager:Stekrs"..v..msg_chat_id)     
Redis:del(aykafwra.."Add:Rd:Manager:Text"..v..msg_chat_id)   
Redis:del(aykafwra.."Add:Rd:Manager:Photo"..v..msg_chat_id)
Redis:del(aykafwra.."Add:Rd:Manager:Video"..v..msg_chat_id)
Redis:del(aykafwra.."Add:Rd:Manager:File"..v..msg_chat_id)
Redis:del(aykafwra.."Add:Rd:Manager:video_note"..v..msg_chat_id)
Redis:del(aykafwra.."Add:Rd:Manager:Audio"..v..msg_chat_id)
Redis:del(aykafwra.."List:Manager"..msg_chat_id)
end
...
text = "𖥔 قائمه الردود \n⩹━━━━𖥕aykafwra𖥕━━━━⩺\n"
for k,v in pairs(list) do
if Redis:get(aykafwra.."Add:Rd:Manager:Gif"..v..msg_chat_id) then
db = "متحركه 🎭"
elseif Redis:get(aykafwra.."Add:Rd:Manager:Vico"..v..msg_chat_id) then
db = "بصمه 📢"
elseif Redis:get(aykafwra.."Add:Rd:Manager:Stekrs"..v..msg_chat_id) then
db = "ملصق 🃏"
elseif Redis:get(aykafwra.."Add:Rd:Manager:Text"..v..msg_chat_id) then
db = "رساله ✉"
elseif Redis:get(aykafwra.."Add:Rd:Manager:Photo"..v..msg_chat_id) then
db = "صوره 🎇"
elseif Redis:get(aykafwra.."Add:Rd:Manager:Video"..v..msg_chat_id) then
db = "فيديو 📹"
elseif Redis:get(aykafwra.."Add:Rd:Manager:File"..v..msg_chat_id) then
db = "ملف 𖥔"
elseif Redis:get(aykafwra.."Add:Rd:Manager:Audio"..v..msg_chat_id) then
db = "اغنيه 🎵"
elseif Redis:get(aykafwra.."Add:Rd:Manager:video_note"..v..msg_chat_id) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(aykafwra.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(aykafwra.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true2")
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 ارسل الان الكلمه لحذفها من الردود","md",true)  
end
if text and not Redis:sismember(aykafwra.."Spam:Group"..msg.sender.user_id,text) then
Redis:del(aykafwra.."Spam:Group"..msg.sender.user_id) 
end
...
local list = Redis:smembers(aykafwra.."List:Rd:Sudo")
for k,v in pairs(list) do
Redis:del(aykafwra.."Add:Rd:Sudo:Gif"..v)   
Redis:del(aykafwra.."Add:Rd:Sudo:vico"..v)   
Redis:del(aykafwra.."Add:Rd:Sudo:stekr"..v)     
Redis:del(aykafwra.."Add:Rd:Sudo:Text"..v)   
Redis:del(aykafwra.."Add:Rd:Sudo:Photoc"..v)
Redis:del(aykafwra.."Add:Rd:Sudo:Photo"..v)
Redis:del(aykafwra.."Add:Rd:Sudo:Video"..v)
Redis:del(aykafwra.."Add:Rd:Sudo:File"..v)
Redis:del(aykafwra.."Add:Rd:Sudo:Audio"..v)
Redis:del(aykafwra.."Add:Rd:Sudo:video_note"..v)
Redis:del(aykafwra.."List:Rd:Sudo")
end
...
text = "\n📝︙قائمة الردود العامه \n⩹━━━━𖥕aykafwra𖥕━━━━⩺\n"
for k,v in pairs(list) do
if Redis:get(aykafwra.."Add:Rd:Sudo:Gif"..v) then
db = "متحركه 🎭"
elseif Redis:get(aykafwra.."Add:Rd:Sudo:vico"..v) then
db = "بصمه 📢"
elseif Redis:get(aykafwra.."Add:Rd:Sudo:stekr"..v) then
db = "ملصق 🃏"
elseif Redis:get(aykafwra.."Add:Rd:Sudo:Text"..v) then
db = "رساله ✉"
elseif Redis:get(aykafwra.."Add:Rd:Sudo:Photo"..v) then
db = "صوره 🎇"
elseif Redis:get(aykafwra.."Add:Rd:Sudo:Video"..v) then
db = "فيديو 📹"
elseif Redis:get(aykafwra.."Add:Rd:Sudo:File"..v) then
db = "ملف 𖥔"
elseif Redis:get(aykafwra.."Add:Rd:Sudo:Audio"..v) then
db = "اغنيه 🎵"
elseif Redis:get(aykafwra.."Add:Rd:Sudo:video_note"..v) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(aykafwra.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(aykafwra.."Set:On"..msg.sender.user_id..":"..msg_chat_id,true)
...
if not msg.ControllerBot and not Redis:set(aykafwra.."SendBcBot") then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*𖥔 امر المغادره معطل من قبل الاساسي ',"md",true)  
end
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(aykafwra..'Channel:Join')}, },}}
...
Redis:setex(aykafwra.."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(aykafwra.."Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(aykafwra.."Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(aykafwra.."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:setex(aykafwra.."Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(aykafwra..'GetTexting:Devaykafwra'..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:del(aykafwra..'Texting:Devaykafwra')
...
local Name = 'the best 𝚂𝙾𝚄𝚁𝙲𝙴 𝙰𝚈𝙺𝙰𝙵𝚆𝚁𝙰 in tele'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'اضف البوت الي مجموعتك✅', url = 't.me/'..UserBot..'?startgroup=new'}
...
Redis:setex(aykafwra.."Change:Name:Bot"..msg.sender.user_id,300,true) 
...
Redis:del(aykafwra.."Name:Bot") 
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 تم حذف اسم البوت ","md",true)   
end
if text == 'بوت' or text == 'البوت' then
local photo = LuaTele.getUserProfilePhotos(aykafwra)
local ban = LuaTele.getUser(aykafwra)
local Namebot = (Redis:get(aykafwra.."Name:Bot") or "ايكافورا")
local BotName = {
...
if text == (Redis:get(aykafwra.."Name:Bot") or "ايكافورا") then
local photo = LuaTele.getUserProfilePhotos(aykafwra)
local ban = LuaTele.getUser(aykafwra)
local Namebot = (Redis:get(aykafwra.."Name:Bot") or "ايكافورا")
local BotName = {
...
x = x + 1
Redis:srem(aykafwra..'Num:User:Pv',v)
end
end
if x ~= 0 then
...
local Get_Chat = LuaTele.getChat(v)
if Get_Chat.id then
local statusMem = LuaTele.getChatMember(Get_Chat.id,aykafwra)
if statusMem.status.luatele == "chatMemberStatusMember" then
x = x + 1
LuaTele.sendText(Get_Chat.id,0,'*𖥔 البوت عظو في الجروب سوف اغادر ويمكنك تفعيلي مره اخره *',"md")
Redis:srem(aykafwra..'ChekBotAdd',Get_Chat.id)
local keys = Redis:keys(aykafwra..'*'..Get_Chat.id)
for i = 1, #keys do
Redis:del(keys[i])
end
...
x = x + 1
local keys = Redis:keys(aykafwra..'*'..v)
for i = 1, #keys do
Redis:del(keys[i])
end
Redis:srem(aykafwra..'ChekBotAdd',v)
LuaTele.leaveChat(v)
end
end
if x ~= 0 then
...
Redis:set(aykafwra.."Game:Smile"..msg.chat_id,SM)
...
"سؤال ينرفزك ؟ ", 
" هل يعجبك سورس ايكافورا ؟؟ ", 
" اكثر ممثل تحبه ؟ ", 
"قد تخيلت شي في بالك وصار ؟ ", 
"شيء عندك اهم من الناس ؟ ", 
"تفضّل النقاش الطويل او تحب الاختصار ؟ ", 
"وش أخر شي ضيعته؟ ", 
"اي رايك في سورس ايكافورا ؟ ", 
"كم مره حبيت؟ ", 
...
if Redis:get(aykafwra.."Status:Games"..msg.chat_id) then
Redis:del(aykafwra.."Set:Country"..msg.chat_id)
...
Redis:set(aykafwra.."Game:Countrygof"..msg.chat_id,name)
...
Redis:set(aykafwra.."Game:Monotonous"..msg.chat_id,name)
...
Redis:set(aykafwra.."Game:Riddles"..msg.chat_id,name)
...
if text == "معاني" then
if Redis:get(aykafwra.."Status:Games"..msg.chat_id) then
Redis:del(aykafwra.."Set:Maany"..msg.chat_id)
Maany_Rand = {"قرد","دجاجه","بطريق","ضفدع","بومه","نحله","ديك","جمل","بقره","دولفين","تمساح","قرش","نمر","اخطبوط","سمكه","خفاش","اسد","فأر","ذئب","فراشه","عقرب","زرافه","قنفذ","تفاحه","باذنجان"}
name = Maany_Rand[math.random(#Maany_Rand)]
Redis:set(aykafwra.."Game:Meaningof"..msg.chat_id,name)
...
if text == "العكس" then
if Redis:get(aykafwra.."Status:Games"..msg.chat_id) then
Redis:del(aykafwra.."Set:Aks"..msg.chat_id)
katu = {"باي","فهمت","موزين","اسمعك","احبك","موحلو","نضيف","حاره","ناصي","جوه","سريع","ونسه","طويل","سمين","ضعيف","شريف","شجاع","رحت","عدل","نشيط","شبعان","موعطشان","خوش ولد","اني","هادئ"}
name = katu[math.random(#katu)]
Redis:set(aykafwra.."Game:Reflection"..msg.chat_id,name)
...
Redis:set(aykafwra.."Game:Estimate"..msg.chat_id..msg.sender.user_id,Num)  
...
Redis:set(aykafwra.."Game:Difference"..msg.chat_id,name)
...
Redis:set(aykafwra.."Game:Example"..msg.chat_id,name)
...
local NumberGame = Redis:get(aykafwra.."Num:Add:Games"..msg.chat_id..msg.sender.user_id)
...
Redis:decrby(aykafwra.."Num:Add:Games"..msg.chat_id..msg.sender.user_id,NumGame)  
Redis:incrby(aykafwra.."Num:Message:User"..msg.chat_id..":"..msg.sender.user_id,NumGame)  
...
Redis:incrby(aykafwra.."Num:Add:Games"..msg.chat_id..Message_Reply.sender.user_id, text:match("^اضف مجوهرات (%d+)$"))  
...
Redis:incrby(aykafwra.."Num:Message:User"..msg.chat_id..":"..Message_Reply.sender.user_id, text:match("^اضف رسائل (%d+)$"))  
...
local Num = Redis:get(aykafwra.."Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
if Num == 0 then 
...
Redis:set(aykafwra.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(aykafwra.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(aykafwra.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ا','ايدي')
Redis:set(aykafwra.."Get:Reides:Commands:Group"..msg_chat_id..":"..'م','رفع مميز')
Redis:set(aykafwra.."Get:Reides:Commands:Group"..msg_chat_id..":"..'اد', 'رفع ادمن')
Redis:set(aykafwra.."Get:Reides:Commands:Group"..msg_chat_id..":"..'مد','رفع مدير')
Redis:set(aykafwra.."Get:Reides:Commands:Group"..msg_chat_id..":"..'من', 'رفع منشئ')
Redis:set(aykafwra.."Get:Reides:Commands:Group"..msg_chat_id..":"..'اس', 'رفع منشئ اساسي')
Redis:set(aykafwra.."Get:Reides:Commands:Group"..msg_chat_id..":"..'مط','رفع مطور')
Redis:set(aykafwra.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تك','تنزيل الكل')
Redis:set(aykafwra.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ر','الرابط')
Redis:set(aykafwra.."Get:Reides:Commands:Group"..msg_chat_id..":"..'رر','الردود')
Redis:set(aykafwra.."Get:Reides:Commands:Group"..msg_chat_id..":"..'،،','مسح المكتومين')
Redis:set(aykafwra.."Get:Reides:Commands:Group"..msg_chat_id..":"..'رد','اضف رد')
Redis:set(aykafwra.."Get:Reides:Commands:Group"..msg_chat_id..":"..'سح','مسح سحكاتي')
Redis:set(aykafwra.."Get:Reides:Commands:Group"..msg_chat_id..":"..'غ','غنيلي')
Redis:set(aykafwra.."Get:Reides:Commands:Group"..msg_chat_id..":"..'رس','رسائلي')
Redis:set(aykafwra.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ثانوي','رفع مطور ثانوي')
...
local ban = LuaTele.getUser(aykafwra)
local bain = LuaTele.getUser(msg.sender.user_id)
Redis:sadd(aykafwra..'Num:User:Pv',msg.sender.user_id)  
if not msg.ControllerBot then
if not Redis:get(aykafwra.."Start:Bot") then
...
local CmdStart = '*\n𖥔 أهلآ بك في بوت '..(Redis:get(aykafwra.."Name:Bot") or "ايكافورا")..
...
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(aykafwra.."Start:Bot"),"md",false, false, false, false, reply_markup)
end
end
else
...
{
{text = 'المبرمج زياد',type = 'text'},{text = 'المطور',type = 'text'},
},
{
...
if text == 'المبرمج زياد' or text == 'زوز' or text == 'زياد' or text == 'زيزو' then  
local UserId_Info = LuaTele.searchPublicChat("X_x_Z_i_a_d_x_X")
if UserId_Info.id then
local  ban = LuaTele.getUser(UserId_Info.id)
local  bain = LuaTele.getUserFullInfo(Sudo_Id)
...
Redis:setex(aykafwra.."Change:Start:Bot"..msg.sender.user_id,300,true) 
...
if not msg.ControllerBot then
if Redis:get(aykafwra.."TwaslBot") and not Redis:sismember(aykafwra.."BaN:In:Tuasl",msg.sender.user_id) then
local ListGet = {Sudo_Id,msg.sender.user_id}
local IdSudo = LuaTele.getChat(ListGet[1]).id
local IdUser = LuaTele.getChat(ListGet[2]).id
local FedMsg = LuaTele.sendForwarded(IdSudo, 0, IdUser, msg_id)
Redis:setex(aykafwra.."Twasl:UserId"..msg.date,172800,IdUser)
...
local Info_User = Redis:get(aykafwra.."Twasl:UserId"..Message_Get.forward_info.date) or 46899864
if text == 'حظر' then
Redis:sadd(aykafwra..'BaN:In:Tuasl',Info_User)  
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Info_User,'𖥔 تم حظره من تواصل البوت ').Reply,"md",true)  
end 
if text =='الغاء الحظر' or text =='الغاء حظر' then
Redis:srem(aykafwra..'BaN:In:Tuasl',Info_User)  
...
Redis:srem(aykafwra.."ChekBotAdd",'-100'..data.supergroup.id)
local keys = Redis:keys(aykafwra..'*'..'-100'..data.supergroup.id..'*')
Redis:del(aykafwra.."List:Manager"..'-100'..data.supergroup.id)
Redis:del(aykafwra.."Command:List:Group"..'-100'..data.supergroup.id)
for i = 1, #keys do 
Redis:del(keys[i])
end
...
if msg.content.video_note then
if msg.content.video_note.video.remote.id == Redis:get(aykafwra.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(aykafwra.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
if idPhoto == Redis:get(aykafwra.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(aykafwra.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.sticker then 
if msg.content.sticker.sticker.remote.id == Redis:get(aykafwra.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(aykafwra.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.voice_note then 
if msg.content.voice_note.voice.remote.id == Redis:get(aykafwra.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(aykafwra.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.video then 
if msg.content.video.video.remote.id == Redis:get(aykafwra.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(aykafwra.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.animation then 
if msg.content.animation.animation.remote.id ==  Redis:get(aykafwra.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(aykafwra.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.document then
if msg.content.document.document.remote.id == Redis:get(aykafwra.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(aykafwra.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.audio then
if msg.content.audio.audio.remote.id == Redis:get(aykafwra.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(aykafwra.."PinMsegees:"..msg.chat_id)
end
elseif text then
if text == Redis:get(aykafwra.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(aykafwra.."PinMsegees:"..msg.chat_id)
end
end
...
if Redis:get(aykafwra.."Lock:tagservr"..data.message.chat_id) then
LuaTele.deleteMessages(data.message.chat_id,{[1]= data.message.id})
end
end 
if tonumber(data.message.sender.user_id) == tonumber(aykafwra) then
return false
end
if data.message.content.luatele == "messageChatJoinByLink" and Redis:get(aykafwra..'Status:joinet'..data.message.chat_id) == 'true' then
    local reply_markup = LuaTele.replyMarkup{
    type = 'inline',
    data = {
    {
...
if Message_Edit.sender.user_id == aykafwra then
print('This is Edit for Bot')
return false
end
File_Bot_Run(Message_Edit,Message_Edit)
Redis:incr(aykafwra..'Num:Message:Edit'..data.chat_id..Message_Edit.sender.user_id)
if Message_Edit.content.luatele == "messageContact" or Message_Edit.content.luatele == "messageVideoNote" or Message_Edit.content.luatele == "messageDocument" or Message_Edit.content.luatele == "messageAudio" or Message_Edit.content.luatele == "messageVideo" or Message_Edit.content.luatele == "messageVoiceNote" or Message_Edit.content.luatele == "messageAnimation" or Message_Edit.content.luatele == "messagePhoto" then
if Redis:get(aykafwra.."Lock:edit"..data.chat_id) then
...
Redis:incrby(aykafwra.."Num:Add:Games"..ChatId..IdUser, 1)  
...
local TextHelp = [[*
• أهلا بك في قائمة العاب سورس ايكافورا اختر نوع الالعاب 
*]]
LuaTele.editMessageText(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
...
local TextHelp = [[*
• مرحبا بك في الالعاب المتطورة الخاص بسورس ايكافورا 
...
Redis:set(aykafwra.."zhrfa"..IdUser,"sendzh") 
end 
if Text == '/leftz@' then
LuaTele.editMessageText(ChatId,Msg_id,"*𖥔 ارسل الكلمه لزخرفتها عربي او انجلش*","md",true) 
Redis:set(aykafwra.."zhrfa"..IdUser,"sendzh") 
...
Redis:set(aykafwra.."rank_tf"..IdUser,"rank_tk") 
end
end 
...
Redis:set(aykafwra.."AddSudosNew"..ChatId,true)
end
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(aykafwra.."AddSudosNew"..ChatId)
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Lock:Link"..ChatId,"del")  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Lock:Spam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Lock:Keyboard"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Lock:vico"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Lock:Animation"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Lock:Document"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Lock:Video"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Lock:Photo"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Lock:User:Name"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Lock:hashtak"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Lock:Bot:kick"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Lock:forward"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Lock:Audio"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Lock:Sticker"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Lock:Contact"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Lock:Join"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Lock:AddMempar"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Lock:Unsupported"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."lockpin"..ChatId,(LuaTele.getChatPinnedMessage(ChatId).id or true)) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Lock:tagservr"..ChatId,true)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Lock:Markdaun"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Lock:edit"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Lock:geam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(aykafwra.."Spam:Group:User"..ChatId ,"Spam:User","del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Lock:Link"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Lock:Spam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Lock:Keyboard"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Lock:vico"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Lock:Animation"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Lock:Document"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Lock:Video"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Lock:Photo"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Lock:User:Name"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Lock:hashtak"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Lock:forward"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Lock:Audio"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Lock:Sticker"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Lock:Contact"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Lock:Unsupported"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Lock:Markdaun"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Lock:geam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(aykafwra.."Spam:Group:User"..ChatId ,"Spam:User","keed")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Lock:Link"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Lock:Spam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Lock:Keyboard"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Lock:vico"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Lock:Animation"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Lock:Document"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Lock:Video"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Lock:Photo"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Lock:User:Name"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Lock:hashtak"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Lock:forward"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Lock:Audio"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Lock:Sticker"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Lock:Contact"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Lock:Unsupported"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Lock:Markdaun"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Lock:geam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(aykafwra.."Spam:Group:User"..ChatId ,"Spam:User","mute")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Lock:Link"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Lock:Spam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Lock:Keyboard"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Lock:vico"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Lock:Animation"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Lock:Document"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Lock:Video"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Lock:Photo"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Lock:User:Name"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Lock:hashtak"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Lock:forward"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Lock:Audio"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Lock:Sticker"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Lock:Contact"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Lock:Unsupported"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Lock:Markdaun"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Lock:geam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(aykafwra.."Spam:Group:User"..ChatId ,"Spam:User","kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(aykafwra.."Status:Link"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(aykafwra.."Status:Welcome"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(aykafwra.."Status:Id"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(aykafwra.."rb:bna"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"𖥔 تم تعطيل امر الايدي").unLock, 'md', true, false, reply_markup)
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(aykafwra.."Status:IdPhoto"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(aykafwra.."Status:Reply"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(aykafwra.."Status:ReplySudo"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(aykafwra.."Status:SetId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(aykafwra.."Status:BanId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(aykafwra.."Status:Games"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(aykafwra.."Status:KickMe"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Status:Link"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Status:Welcome"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Status:Id"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Status:IdPhoto"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Status:Reply"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Status:ReplySudo"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Status:SetId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Status:BanId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Status:Games"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."rb:bna"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(aykafwra.."Status:KickMe"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"𖥔 تم تفعيل امر اطردني").unLock, 'md', true, false, reply_markup)
end
end
...
if Info_Members.members[k].bot_info == nil then
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(aykafwra.."TheBasics:Group"..UserId[2],v.member_id.user_id) 
x = x + 1
else
Redis:sadd(aykafwra.."Addictive:Group"..UserId[2],v.member_id.user_id) 
y = y + 1
end
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:set(aykafwra.."Lock:tagservrbot"..UserId[2],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(aykafwra..''..lock..UserId[2],"del")    
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:del(aykafwra.."Lock:tagservrbot"..UserId[2],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:del(aykafwra..''..lock..UserId[2],"del")    
end
LuaTele.answerCallbackQuery(data.id, "𖥔 تم قفل جميع الاوامر بنجاح  ", true)
end
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(aykafwra.."Lock:Link"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(aykafwra.."Lock:Spam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(aykafwra.."Lock:Keyboard"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(aykafwra.."Lock:vico"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(aykafwra.."Lock:Animation"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(aykafwra.."Lock:Document"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(aykafwra.."Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(aykafwra.."Lock:Video"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(aykafwra.."Lock:Photo"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(aykafwra.."Lock:User:Name"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(aykafwra.."Lock:hashtak"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(aykafwra.."Lock:Bot:kick"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(aykafwra.."Lock:forward"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(aykafwra.."Lock:Audio"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(aykafwra.."Lock:Sticker"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(aykafwra.."Lock:Contact"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(aykafwra.."Lock:Join"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(aykafwra.."Lock:AddMempar"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(aykafwra.."Lock:Unsupported"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(aykafwra.."lockpin"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(aykafwra.."Lock:tagservr"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(aykafwra.."Lock:Markdaun"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(aykafwra.."Lock:edit"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(aykafwra.."Lock:geam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hdel(aykafwra.."Spam:Group:User"..ChatId ,"Spam:User")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(aykafwra.."TheBasics:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(aykafwra.."TheBasicsQ:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(aykafwra.."Originators:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(aykafwra.."Managers:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(aykafwra.."Addictive:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(aykafwra.."Distinguished:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(aykafwra.."BanGroup:Group"..ChatId) 
LuaTele.editMessageText(ChatId,Msg_id,"𖥔 تم مسح المحظورين", 'md', false)
end
elseif Text and Text:match('(%d+)/SilentGroupGroup') then
local UserId = Text:match('(%d+)/SilentGroupGroup')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(aykafwra.."SilentGroup:Group"..ChatId) 
